...
if (window.URLSearchParams !== undefined) {
    ...
    if (searchParams.has("dark") && searchParams.get("dark") === "1") {
        document
            .querySelector("body")
            .classList.add("skin-experiment-dark-mode");
    }
}
...
class ProgressBarExpressive {
    ...
    queueNextMessage() {
        if (this.isInitialized && this.messages.length > 1) {
            ...
            this.nextMessageEl.classList.add(
...
document.querySelectorAll(".listbox-button").forEach(function (widgetEl) {
    const isPhoneInput =
        widgetEl.parentElement.classList.contains("phone-input");
    if (isPhoneInput) {
        return;
    }
...
document
    ...
    .forEach(function (widgetEl) {
        ...
        widgetEl.addEventListener("makeup-listbox-button-change", (e) => {
            ...
            widgetEl.nextElementSibling.querySelector(
                ".textbox > span",
            ).textContent =
    ...
    document
        ...
        .forEach(function (elChipsCombobox) {
            ...
            const elChipsItems = elChipsCombobox.querySelector(
                ...
                elCombobox = elChipsCombobox.querySelector(
                    ".chips-combobox__combobox",
                ),
                elComboboxOptions =
                    elCombobox.querySelector(".combobox__options"),
            ...
            elChipsCombobox.addEventListener("click", function (event) {
                ...
                if (elClicked.matches(sChipDeleteSelector)) {
                    const sChipText =
                        elClicked.previousElementSibling.innerText.trim();
            ...
            `;
                elComboboxOptions.insertAdjacentHTML(
                    "beforeend",
                    sComboboxItem,
                );
            }
