...
describe.skip("given an number input textbox", () => {
  ...
  describe("increment is pressed", () => {
    ...
    it("it should increment the value", async () => {
      await waitFor(() => {
        expect(component.getByLabelText("Enter a number").value).toBe("2");
      });
    });
  ...
  describe("decrement is pressed", () => {
    ...
    it("it should decrement the value", async () => {
      await waitFor(() => {
        expect(component.getByLabelText("Enter a number").value).toBe("0");
      });
    });
    it("should trigger increment event", async () => {
      await waitFor(() => {
...
describe.skip("given an number input textbox with delete", () => {
  ...
  describe("increment is pressed", () => {
    ...
    it("it should increment the value and hide delete button", async () => {
      await waitFor(() => {
        expect(component.queryByLabelText("Delete item")).not.toBeVisible();
      });
    });
...
describe.skip("given an number-input textbox with constraints", () => {
  ...
  describe("increment is pressed", () => {
    ...
    it("it should decrement the value", async () => {
      await waitFor(() => {
        expect(component.getByLabelText("Enter a number").value).toBe("10");
      });
    });
  ...
  describe("decrement is pressed", () => {
    ...
    it("it should decrement the value", async () => {
      await waitFor(() => {
        expect(component.getByLabelText("Enter a number").value).toBe("9");
      });
    });
