...
export const EbayIconAuthenticityGuaranteeFilled24: EbayIconComponent = props => (
    <EbayIcon {...props} name="authenticityGuaranteeFilled24" __type="icon" __symbol={SYMBOL} />
);