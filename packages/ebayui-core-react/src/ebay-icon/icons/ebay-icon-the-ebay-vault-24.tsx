...
/** @deprecated Use EbayIconPsaVault24 instead. */
export const EbayIconTheEbayVault24: EbayIconComponent = props => (
    <EbayIcon {...props} name="theEbayVault24" __type="icon" __symbol={SYMBOL} />
);