...
export const Default: StoryFn<typeof EbayNumberInput> = (args) => <EbayNumberInput {...args} />;

export const WithCustomMinAndMax: StoryFn<typeof EbayNumberInput> = (args) => (
    <EbayNumberInput {...args} min={20} max={30} value={20} />
);

export const WithDelete: StoryFn<typeof EbayNumberInput> = (args) => (
    <EbayNumberInput {...args} min={1} max={30} value={1} a11yDeleteText={"Delete"} />
);

export const WithLabel: StoryFn<typeof EbayNumberInput> = (args) => (
    <EbayNumberInput {...args} min={1} max={10} value={1} label={"Enter a number"} />
);

export const WithAriaLabel: StoryFn<typeof EbayNumberInput> = (args) => (
    <EbayNumberInput {...args} min={1} max={10} value={1} aria-label="Qty" />
);
