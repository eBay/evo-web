...
export const EvoIconAuthenticityGuaranteeFilled24Colored: EvoIconComponent = props => (
    <EvoIcon {...props} name="authenticityGuaranteeFilled24Colored" __symbol={SYMBOL} />
);
