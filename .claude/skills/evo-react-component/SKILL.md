...
```tsx
export interface EvoAvatarProps
...
```tsx
return (
    <div {...rest} ref={ref} className={classes} role="img" aria-label={a11yText ?? undefined}>
        {image ? (
...
describe("EvoAvatar", () => {
    it("renders with accessible label", () => {
        ...
        expect(screen.getByRole("img", { name: "Profile photo of Alex" })).toBeInTheDocument();
    });
