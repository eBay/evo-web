...
`,E=e=>({input:e}),j={title:"form input/ebay-switch",component:l,parameters:{docs:{description:{component:x}}},argTypes:{onChange:{action:"on-change",description:"Triggered on change",table:{category:"Events",defaultValue:{summary:"{ originalEvent, value, checked }"}}}}},n=e=>({input:e,component:r});n.args={};n.parameters={docs:{source:{code:C}}};const s=e=>({input:e,component:i});s.args={};s.parameters={docs:{source:{code:T}}};const a=E.bind({});a.args={};a.parameters={docs:{source:{code:I("ebay-switch",a.args)}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: Input) => ({
  input: args,
  ...
  input: args
})`,...a.parameters?.docs?.source}}};const B=["WithLabel","Disabled","Isolated"];export{s as Disabled,a as Isolated,n as WithLabel,B as __namedExportsOrder,j as default};
