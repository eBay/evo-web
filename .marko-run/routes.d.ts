...
declare module "@marko/run" {
	interface AppData extends Run.DefineApp<{
		routes: {
			...
			"/components/star-range": { verb: "get"; meta: typeof import("../src/routes/_index/components/star-range/+meta.json"); };
			"/components/star-range/accessibility": { verb: "get"; meta: typeof import("../src/routes/_index/components/star-range/accessibility+meta.json"); };
			"/components/star-range/css": { verb: "get"; meta: typeof import("../src/routes/_index/components/star-range/css+meta.json"); };
...
declare module "../src/routes/_index/components/star-range/+page.marko" {
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    export type Route = Run.Routes["/components/star-range"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    /** @deprecated use `((context, next) => { ... }) satisfies MarkoRun.Handler` instead */
    export const route: Run.HandlerTypeFn<Route>;
...
declare module "../src/routes/_index/components/star-range/accessibility+page.marko" {
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    export type Route = Run.Routes["/components/star-range/accessibility"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    /** @deprecated use `((context, next) => { ... }) satisfies MarkoRun.Handler` instead */
    export const route: Run.HandlerTypeFn<Route>;
...
declare module "../src/routes/_index/components/star-range/css+page.marko" {
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    export type Route = Run.Routes["/components/star-range/css"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    /** @deprecated use `((context, next) => { ... }) satisfies MarkoRun.Handler` instead */
    export const route: Run.HandlerTypeFn<Route>;
