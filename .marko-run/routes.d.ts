...
declare module "@marko/run" {
  interface AppData extends Run.DefineApp<{
    routes: {
      ...
      "/components/video": {
        verb: "get";
        meta: typeof import("../src/routes/_index/components/video/+meta.json");
      };
      "/components/video/css": {
        verb: "get";
        meta: typeof import("../src/routes/_index/components/video/css+meta.json");
      };
      "/guides": {
        verb: "get";
...
declare module "../src/routes/_index/components/video/+page.marko" {
  namespace MarkoRun {
    ...
    export type Route = Run.Routes["/components/video"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    /** @deprecated use `((context, next) => { ... }) satisfies MarkoRun.Handler` instead */
    export const route: Run.HandlerTypeFn<Route>;
...
declare module "../src/routes/_index/components/video/css+page.marko" {
  namespace MarkoRun {
    ...
    export type Route = Run.Routes["/components/video/css"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    /** @deprecated use `((context, next) => { ... }) satisfies MarkoRun.Handler` instead */
    export const route: Run.HandlerTypeFn<Route>;
