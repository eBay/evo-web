...
<ebay-table ...input>
    <@header row-header>Seller</@header>
    <@header>Item</@header>
    <@header>Status</@header>
    <@header column-type="numeric">List Price</@header>
    <@header column-type="numeric">Quantity Available</@header>
    <@header>Orders</@header>
    <@header column-type="numeric">Watchers</@header>
    <@header column-type="numeric">Protection</@header>
    ...
    <for|r| of=data>
        <@row>
            ...
            <@cell><a href="https://ebay.com">\${r.orders.number}</a></@cell>
...
<ebay-table ...input>
    ...
    <@header column-type="layout">Mutiple Actions</@header>
    <@header column-type="icon-action">Actions Plus</@header>
    <@header column-type="numeric">List Price</@header>
    <@header column-type="numeric">Quantity Available</@header>
    <@header>Orders</@header>
    <@header column-type="numeric">Watchers</@header>
...
<ebay-table on-sort("onSort") ...input>
    <@header name="sellerCol" row-header sort=state.sorted.sellerCol || "none">
        Seller
    </@header>
    <@header name="itemCol" sort=state.sorted.itemCol || "none">Item</@header>
...
<ebay-table on-sort("onSort") ...input>
    <@header name="sellerCol" row-header>Seller</@header>
    <@header name="itemCol">Item</@header>
    <@header name="statusCol">Status</@header>
    <@header
        name="listPriceCol"
        column-type="numeric"
        sort=state.sorted.listPriceCol || "none"
    ...
    <@header name="orderCol">Orders</@header>
    <@header name="watchersCol" column-type="numeric">Watchers</@header>
    <@header name="protectionCol" column-type="numeric">Protection</@header>
    <@header name="shippingCol">Shipping</@header>
    <@header name="deliveryCol">Delivery</@header>
    <for|r| of=state.data>
        <@row>
            <@cell>\${r.seller}</@cell>
            <@cell>\${r.item.title}</@cell>
