import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-CK-NQdWx.js";import{t as r}from"./classnames-D09xBJOL.js";import{r as i}from"./utils-i55QFFMK.js";import{n as a}from"./iframe-6gf7cGMn.js";import{n as o,t as s}from"./ebay-details-BzCTugq6.js";import{t as c}from"./utils-BI15M-bA.js";import{i as l,n as u,r as d,t as f}from"./ebay-icon-graph-16-CFTy1lES.js";import{n as p,t as m}from"./ebay-icon-lightbulb-16-BQR8ekmF.js";var h,g,_;function v(){return(v=t((()=>{h=e(r()),g=e(n()),s(),c(),_=({size:e,autoCollapse:t,className:n,children:r,onToggle:a,"aria-roledescription":s=`accordion`,...c})=>{let l=(0,g.useRef)(null),[u,d]=(0,g.useState)(!1),f=i(r,o);if(!f.length)throw Error(`EbayAccordion: Please use a
        EbayDetails that defines the sections of the accordion`);let p=f.map((e,n)=>g.cloneElement(e,{onToggle:(r,{open:i})=>{d(!0),t&&i&&(l.current?.querySelectorAll(`details`))?.forEach((e,t)=>{t!==n&&(e.open=!1)}),e.props.onToggle?.(r,{open:i}),a?.(r,{open:i,index:n})}}));return g.createElement(`ul`,{...c,ref:l,className:(0,h.default)(`accordion`,n,{"accordion--large":e===`large`,"accordion--animated":u}),"aria-roledescription":s},p.map(e=>g.createElement(`li`,{key:e.key},e)))};try{_.displayName=`accordion`,_.__docgenInfo={description:``,displayName:`accordion`,filePath:`/home/runner/work/evo-web/evo-web/packages/ebayui-core-react/src/ebay-accordion/accordion.tsx`,methods:[],props:{size:{defaultValue:null,declarations:[{fileName:`ebayui-core-react/src/ebay-accordion/accordion.tsx`,name:`TypeLiteral`}],description:``,name:`size`,required:!1,tags:{},type:{name:`"regular" | "large" | undefined`}},autoCollapse:{defaultValue:null,declarations:[{fileName:`ebayui-core-react/src/ebay-accordion/accordion.tsx`,name:`TypeLiteral`}],description:``,name:`autoCollapse`,required:!1,tags:{},type:{name:`boolean | undefined`}}},tags:{}}}catch{}})))()}function y(){return(y=t((()=>{v(),s()})))()}var b,x,S,C,w,T,E,D;function O(){return(O=t((()=>{n(),y(),s(),l(),u(),p(),b=a(),x={component:_,title:`navigation & disclosure/ebay-accordion`,argTypes:{size:{description:`Size of the accordion`,table:{defaultValue:{summary:`regular`}},options:[`regular`,`large`],control:{type:`select`}},autoCollapse:{type:`boolean`,description:`Whether to auto collapse`,table:{defaultValue:{summary:`false`}}},onToggle:{action:`onToggle`,description:`Triggered on toggle`,table:{category:`Events`,defaultValue:{summary:`event, { open, index }`}}}},tags:[`autodocs`],parameters:{docs:{description:{component:`## Usage
