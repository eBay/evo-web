...
\`\`\``,displayName:`EvoCheckbox`,filePath:`/home/runner/work/evo-web/evo-web/packages/evo-react/src/checkbox/checkbox.tsx`,methods:[],props:{size:{defaultValue:null,declarations:[{fileName:`evo-react/src/checkbox/types.ts`,name:`TypeLiteral`}],description:`Uses the large checkbox icon. Omit for the default size.`,name:`size`,required:!1,tags:{},type:{name:`enum`,raw:`"large"`,value:[{value:`"large"`}]}}},tags:{summary:`Native checkbox with Skin styling.`}}}catch{}})))()}export{g as n,p as t};