import{_ as e,i as a}from"./_D4nNAwqH.js";import"./_F1jt4Ftm.js";e("H815CsS",t=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
  ...
  <main>
    ...
    `},500),setTimeout(()=>{document.querySelector(".demo-skeleton").innerHTML=`
      ...
      `},3500),setTimeout(()=>{document.body.innerHTML+=`
    ...
    `},3750)}));a();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order.example-1b-C_Ko1vIg.js.map
