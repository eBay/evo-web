import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./utils-CkiB0p9L.js";import{ft as n,i as r,k as i,n as a,nt as o,r as s,t as c,tt as l}from"./dom-CNWckxLY.js";import{a as u,i as d,o as f,r as p,t as m}from"./evo-file-preview-card-group-DGoWmO-e.js";var h;function g(){return(g=e((()=>{h=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
...
`})))()}function j(e){e.a,I(e,{name:`frog.jpg`,type:`image/jpeg`,src:`https://ir.ebaystatic.com/cr/v/c01/skin/docs/tb-real-square-pic.jpg`})}function M(){console.log(`see more clicked`)}var N,P,F,I,L,R,z,B;function V(){return(V=e((()=>{f(),r(),N=p,P=(e=>`/${e}&`)(d),F=l(4,e=>{let t;n([...Array(35)],n=>{t=s(t,{file:e.d,deleteAction:a({a11yText:`Delete`,onClick:z({f:n})}),cancelAction:a({a11yText:`Cancel upload`,onClick:R({f:n})})})}),m(e.a,{...e.c,card:t,seeMoreAction:a({a11yText:`See More`,onClick:M})})}),I=i(3,F),L=i(2,F),R=e=>function(){console.log(`cancel upload clicked`,e.f)},z=e=>function(){console.log(`delete clicked`,e.f)},o(`cL997Mc`,M),o(`vHlaBBJ`,R),o(`ngm8dsO`,z),B=c(`V$3rKzd`,N,P,j,L)})))()}var H;function U(){return(U=e((()=>{H=`<const/file={
  name: "frog.jpg",
  type: "image/jpeg",
  src: "https://ir.ebaystatic.com/cr/v/c01/skin/docs/tb-real-square-pic.jpg",
}>
