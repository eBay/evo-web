import{C as e,v as t}from"./_XkvwCyHu.js";import"./_C5Dh7mzz.js";t(`mVQuDIy`,e=>window.addEventListener(`load`,()=>{setTimeout(()=>{document.querySelector(`.page-grid`).innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},750)})),e();
//# sourceMappingURL=guide-examples.skeleton-examples.out-of-order-DVs5AeYZ.js.map