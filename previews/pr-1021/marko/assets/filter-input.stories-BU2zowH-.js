import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./utils-CkiB0p9L.js";import{D as n,M as r,O as i,Y as ee,Z as a,c as te,i as o,k as s,n as c,nt as l,ot as ne,t as u,tt as d}from"./dom-CNWckxLY.js";import{s as re}from"./evo-icon-COXCIbT1.js";import{i as ie,n as ae,t as oe}from"./evo-icon-button-Cv3N38Ss.js";import{a as se,c as ce,i as le,l as ue,n as de,o as fe,r as pe,s as me,t as he,u as ge}from"./evo-icon-clear-16-B_Bo4Ws3.js";import{t as _e}from"./textbox-DrXzZqDe.js";import{i as ve,n as ye,o as be,r as xe,t as Se}from"./evo-input-DHWXnfJU.js";var f;function p(){return(p=e((()=>{f=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        evo-filter-input
    </span>
...
`})))()}function m(){return(m=e((()=>{})))()}function h(){return(h=e((()=>{re(),_e(),m()})))()}function g(e){ye(e.b)}var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,Ce,I,L,R,z,B,V;function H(){return(H=e((()=>{o(),ge(),se(),ie(),be(),h(),_=(e=>`<span>${e}</span>`)(xe),v=(e=>` D/${e}&l`)(ve),y=e=>{de(e.a),he(e.a,{})},b=r(`B1`,pe,(e=>`/${e}&`)(le),y),x=e=>{me(e.a),fe(e.a,{})},S=r(`B2`,ce,(e=>`/${e}&`)(ue),x),C=d(1,e=>oe(e.a,{a11yText:e._._.h,class:`filter-input__clear-btn`,size:`small`,transparent:!0,onClick:B(e),content:b(e)})),w=i(14,C,e=>e._._),T=e=>{w(e),E(e)},E=i(15,C,e=>e._._),D=ee(0,(e=>`<!>${e}<!>`)(ae),(e=>`b/${e}&b`)(`b%c`),T),O=i(15,e=>D(e,+!e._.h)),k=r(`B3`,`<!><!><!>`,`b%`,O),A=d(13,e=>Se(e.b,{...e.l,fluid:!0,type:`search`,"aria-controls":e.i,placeholder:e.m,prefixIcon:c({content:S(e)}),postfixIcon:c({content:k(e)})}),2),j=s(12,A),M=(e,t)=>j(e,t===void 0?`Filter`:t),N=d(10,e=>te(e.a,[`filter-input`,e.j&&`filter-input--${e.j}`,e.f])),P=s(5,N),F=s(9,N),Ce=s(8,A),I=s(11,A),L=(e,t)=>{(({a11yClearButtonText:t,a11yControlsId:n,class:r,placeholder:i,size:ee,...a})=>I(e,a))(t),R(e,t.valueChange),P(e,t.class),M(e,t.placeholder),z(e,t.a11yClearButtonText),Ce(e,t.a11yControlsId),F(e,t.size)},R=s(4,n(w)),z=s(7,n(O,E)),B=e=>function(){(e._._.e||null)?.(``)},l(`B0`,B),V=u(`B`,_,v,g,L)})))()}function we(e){g(e.a)}var U,W,G,K;function Te(){return(Te=e((()=>{H(),o(),U=_,W=(e=>`/${e}&`)(v),G=(e,t)=>L(e.a,{...t,"aria-label":`Filter input`,placeholder:`Filter`,a11yControlsId:`filter-input-default`,a11yClearButtonText:`Clear filter input`}),K=u(`rtEOYbl`,U,W,we,G)})))()}var Ee;function De(){return(De=e((()=>{Ee=`<evo-filter-input
  ...input
...
/>
`})))()}function Oe(e){g(e.a)}var ke,Ae,q,J,je,Y,X,Me;function Ne(){return(Ne=e((()=>{H(),o(),ke=(e=>`<div>${e}<div id=filter-input-controls>Current value: "<!>"</div></div>`)(_),Ae=(e=>`D/${e}&Db%m`)(v),q=d(6,e=>L(e.a,{...e.d,value:e.f,valueChange:X(e),placeholder:`Filter`,a11yControlsId:`filter-input-controls`,"aria-label":`Filter input`,a11yClearButtonText:`Clear filter input`})),J=a(5,e=>{ne(e.b,e.f),q(e)}),je=J,Y=s(3,e=>{je(e,e.d.value),q(e)}),X=e=>t=>{J(e,t)},l(`tx3mR7d`,X),Me=u(`ZOzx3D4`,ke,Ae,Oe,Y)})))()}var Pe;function Fe(){return(Fe=e((()=>{Pe=`export interface Input {
  value: string;
}
