import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./utils-CkiB0p9L.js";import{M as ee,i as n,k as r,n as i,nt as a,t as o}from"./dom-CNWckxLY.js";import{_ as s,a as c,c as l,d as u,f as d,g as f,h as p,i as m,l as h,m as g,n as _,o as v,p as y,r as b,s as x,t as S,u as C}from"./evo-file-preview-card-D3x_o3Gv.js";var w;function T(){return(T=e((()=>{w=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
...
`})))()}function te(e){b(e.a,i({a11yText:`Delete`,onClick:D})),_(e.a,i({a11yText:`Cancel upload`,onClick:E}))}function E(){console.log(`cancel upload clicked`)}function D(){console.log(`delete clicked`)}var O,k,A,j;function M(){return(M=e((()=>{s(),n(),O=(e=>`<!>${e}<!>`)(p),k=(e=>`b/${e}&b`)(`b%c`),A=r(2,e=>{S(e.a,e.c.action),h(e.a,e.c.as),C(e.a,e.c.class),d(e.a,e.c.file),m(e.a,e.c.footerSubtitle),c(e.a,e.c.footerTitle),v(e.a,e.c.href),l(e.a,e.c.infoText),u(e.a,e.c.menuActions),y(e.a,e.c.seeMoreAction),g(e.a,e.c.status),x(e.a,(({action:e,as:t,cancelAction:ee,class:n,deleteAction:r,file:i,footerSubtitle:a,footerTitle:o,href:s,infoText:c,menuActions:l,seeMoreAction:u,status:d,...f})=>f)(e.c))}),a(`x5Ps2Yq`,E),a(`YNzoXg5`,D),j=o(`c1ZJph5`,O,k,te,A)})))()}var N;function P(){return(P=e((()=>{N=`<evo-file-preview-card ...input>
  <@deleteAction
    a11yText="Delete"
    onClick() {
