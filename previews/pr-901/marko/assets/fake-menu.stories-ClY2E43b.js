import{b as i}from"./utils-DyU2_5R1.js";import{_ as t,a as s,b as m,k as n,l}from"./dom-BQBHkMGv.js";import{d as c,b as d,a as p,g as u,f as h,e as f,i as b,$ as g,h as x,c as y,C as _}from"./index-CHVtRxmB.js";import"./iframe-rbTg3zTU.js";import"./preload-helper-PPVm8Dsz.js";import"./index-NgMjXp_2.js";import"./evo-icon-tick-16-C9qCoFGV.js";import"./index-Corjdykz.js";/* empty css             */const C=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        evo-fake-menu
    </span>
...
`,$=c,D=(e=>`/${e}&`)(y),E=t("tjEywg6","item 3"),P=t("zsP3Eag","item 2"),L=t("NW$okPi","item 1 that has very long text");function M(e){g(e.a),x(e.a,n(n(l({href:"#",content:L(e)}),{href:"#",content:P(e)}),{href:"#",content:E(e)}))}const U=m(2,e=>{d(e.a,e.c.class),p(e.a,e.c.classPrefix),u(e.a,e.c.fixWidth),h(e.a,e.c.fixed),f(e.a,e.c.reverse),b(e.a,(({class:v,classPrefix:k,fixWidth:T,fixed:w,item:W,reverse:S,...r})=>r)(e.c))}),H=s("rivr96v",$,D,M,U),N=`<evo-fake-menu ...input>
  <@item href="#">
