import{b as r}from"./utils-DyU2_5R1.js";import{a as p,b as a,B as k,E as C,x,e as g,A as D,p as w,u as z,r as S}from"./dom-BQBHkMGv.js";import{$ as b,a as _,b as h,c as m,d as u,C as O}from"./index-DbzNEJAZ.js";import"./iframe-rbTg3zTU.js";import"./preload-helper-PPVm8Dsz.js";import"./controllable-input.feat-D8X06sdI.js";import"./evo-icon-checkbox-checked-24-C0h_ojVq.js";import"./index-Corjdykz.js";import"./evo-icon-checkbox-checked-18-D-lUFxF7.js";/* empty css              */const E=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        evo-checkbox
    </span>
...
`,L="<div> </div><fieldset><legend>Choose an Option</legend><!></fieldset>",W="D lDb%l",f=g(11,e=>{const t={...e._.d,checked:e.i,checkedChange:K(e),id:e.k,value:e.M,name:"checkbox-group"};b(e.a,t.size),_(e.a,(({class:n,size:s,...o})=>o)(t))},2),$=k(1,f),G=a(10,e=>{S(e.b,"for",e.k),f(e)}),M=e=>{$._(e),T._(e),u(e.a,"field__control"),x(e.c,e.M+1),G(e,w(e))},v=z(8,f),I=g(5,e=>v(e,e.e,U(e))),T=k(1,I),R=a(4,I),A=(e,t)=>R(e,t[0]),j=D(1,(e=>`<span class=field>${e}<label class="field__label field__label--end">Option <!></label></span>`)(h),(e=>`D/${e}& Db%m`)(m),M,A),y=C(4,e=>{x(e.a,e.e.toString()),j(e,[e.e]),T(e)});function B(e){y(e,[!1,!1,!1])}const H=a(3,$),K=e=>t=>{v(e,t)},U=e=>function(t){const n=[...e._.e];n[e.M]=t,y(e._,n)},q=p("Eb36A1l",L,W,B,H),F=h,J=(e=>`/${e}&`)(m),N=()=>{},P=a(2,e=>{u(e.a,e.c.class),b(e.a,e.c.size),_(e.a,(({class:t,size:n,...s})=>s)(e.c))}),V=p("ZPWzKjx",F,J,N,P),X=(e=>`<span class=field>${e}<label class="field__label field__label--end" for=checkbox>Option</label></span>`)(h),Z=(e=>`D/${e}&l`)(m);function Q(e){u(e.a,"field__control")}const Y=a(2,e=>{const t={...e.c,id:"checkbox"};b(e.a,t.size),_(e.a,(({class:n,size:s,...o})=>o)(t))}),ee=p("cMJsALK",X,Z,Q,Y),te=(e=>`<span class=field>${e}<label class="field__label field__label--end field__label--disabled" for=checkbox>Option</label></span>`)(h),ne=(e=>`D/${e}&l`)(m);function ae(e){u(e.a,"field__control")}const oe=a(2,e=>{const t={...e.c,disabled:!0,id:"checkbox"};b(e.a,t.size),_(e.a,(({class:n,size:s,...o})=>o)(t))}),se=p("Xq1FgSd",te,ne,ae,oe),ce=`<let/checkedItems=[false, false, false]>
