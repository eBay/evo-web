import{C as e,v as t}from"./_XkvwCyHu.js";import"./_C5Dh7mzz.js";t(`zM56oIm`,e=>window.addEventListener(`load`,()=>{setTimeout(()=>{document.querySelector(`.page-grid`).innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},4e3)})),e();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order-CeklY8_Q.js.map