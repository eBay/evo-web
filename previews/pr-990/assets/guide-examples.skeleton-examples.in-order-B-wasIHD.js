import{C as e,v as t}from"./_XkvwCyHu.js";import"./_C5Dh7mzz.js";t(`uNEOmLT`,e=>window.addEventListener(`load`,()=>{setTimeout(()=>{document.querySelector(`.page-grid`).innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},1750)})),e();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order-B-wasIHD.js.map