import{a as m,b as f,l as a,_ as O}from"./dom-CQcMsOgj.js";import{b,c as g,e as h,a as v,g as y,h as T,i as w,j as A,k as x,$ as k,l as C,m as j,p as S,f as D,d as M,o as E,n as q,F as V}from"./index-vtQb7WdG.js";import{b as n}from"./utils-DyU2_5R1.js";import"./iframe-BZMe_UG6.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Ddeo_lZV.js";import"./index-BRQvb8o9.js";import"./index-C66xovE_.js";import"./index-CydVXlZl.js";import"./evo-icon-chevron-down-16-PWIL4J-Q.js";import"./index-B2_6BRUp.js";import"./controllable.feat-BUOkN5Na.js";import"./controllable-input.feat-DlB-GNko.js";import"./controllable-open.feat-36QAdjbX.js";import"./controllable-select.feat-BFiBaDmS.js";/* empty css                    */import"./evo-icon-play-16-BNZ1CGNm.js";import"./evo-icon-close-16-CVhjHvya.js";const Z=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
...
`,K=(e=>`<!>${e}<!>`)(q),W=(e=>`b/${e}&b`)(E);function N(e){S(e.a),D(e.a,a({a11yText:"Delete",onClick:Y})),M(e.a,a({a11yText:"Cancel upload",onClick:X}))}const Q=f(2,e=>{b(e.a,e.c.action),g(e.a,e.c.as),h(e.a,e.c.class),v(e.a,e.c.file),y(e.a,e.c.footerSubtitle),T(e.a,e.c.footerTitle),w(e.a,e.c.href),A(e.a,e.c.infoText),x(e.a,e.c.menuActions),k(e.a,e.c.seeMoreAction),C(e.a,e.c.status),j(e.a,(({action:t,as:_,cancelAction:F,class:P,deleteAction:$,file:I,footerSubtitle:R,footerTitle:B,href:J,infoText:U,menuActions:z,seeMoreAction:G,status:H,...u})=>u)(e.c))});function X(){console.log("cancel upload clicked")}function Y(){console.log("delete clicked")}const o=m("c1ZJph5",K,W,N,Q),i=`<evo-file-preview-card ...input>
  <@deleteAction
    a11yText="Delete"
    onClick() {
...
})`,...p.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"buildExtensionTemplate(SeeMoreTemplate, SeeMoreTemplateCode)",...d.parameters?.docs?.source}}};const De=["Uploading","Image","Video","MultipleMenuActions","Document","SeeMore"];export{p as Document,s as Image,c as MultipleMenuActions,d as SeeMore,l as Uploading,r as Video,De as __namedExportsOrder,Se as default};
