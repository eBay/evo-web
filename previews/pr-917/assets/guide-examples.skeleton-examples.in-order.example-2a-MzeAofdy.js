import{_ as e,i as a}from"./_TTDhYmHL.js";import"./_BL69-zKZ.js";e("tWSMR4o",t=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},4e3)}));a();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order.example-2a-MzeAofdy.js.map
