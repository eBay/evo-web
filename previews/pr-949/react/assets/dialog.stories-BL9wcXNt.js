...
}`,...Z.parameters?.docs?.source},description:{story:`Add an image when it provides useful visual context for the dialog.`,...Z.parameters?.docs?.description}}},Q.parameters={...Q.parameters,docs:{...Q.parameters?.docs,source:{originalSource:`{
  render: args => {
    const [open, setOpen] = useState(false);
    const handleOpenChange = (nextOpen: boolean) => {
      setOpen(nextOpen);
...
}`,...$.parameters?.docs?.source},description:{story:`In a multi-step flow, offer a clear way to return to the previous step.`,...$.parameters?.docs?.description}}}})))()}pe();export{Z as Banner,Q as CustomBanner,X as Default,$ as WithPrevious,fe as __namedExportsOrder,Y as default};