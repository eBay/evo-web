import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-CK-NQdWx.js";import{n as r}from"./iframe-Bbauoj5y.js";import{n as i,t as a}from"./ebay-button-DZIxtXwi.js";import{i as o,n as s,t as c}from"./ebay-select-DTUxinMW.js";var l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w;function T(){return(T=t((()=>{l=e(n()),a(),c(),u=r(),{action:d}=__STORYBOOK_MODULE_ACTIONS__,f={title:`form input/ebay-select`,tags:[`autodocs`],parameters:{docs:{description:{component:`This component is used to create a native \`<select>\` form element with default browser styling.
