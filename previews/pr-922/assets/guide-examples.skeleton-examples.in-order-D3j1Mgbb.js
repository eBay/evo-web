import{C as e,v as t}from"./_XkvwCyHu.js";import"./_C5Dh7mzz.js";t(`d5w5mCw`,e=>window.addEventListener(`load`,()=>{setTimeout(()=>{document.querySelector(`.page-grid`).innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
  ...
  <main>
    ...
    `},3750)})),e();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order-D3j1Mgbb.js.map