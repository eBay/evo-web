import{a as N,b as B,c as $,r as p,x as Z,d as nn,i as an,e as Q,f as tn}from"./dom-C92X7IE7.js";import{$ as Y,b as o,c as s,a as c}from"./index-B5-1XC0l.js";import"./iframe-CVMY3Erk.js";import"./preload-helper-PPVm8Dsz.js";function V(n,E,G={},x="",l=!1){const d=x+"	",{body:v,attrs:u}=gn(E,G,d);let k=n;return l&&(k=`@${G[k]||k}`),`<${k+u+(v?`>
${v.replace(/^|\n/gm,`$&${d}`)}
