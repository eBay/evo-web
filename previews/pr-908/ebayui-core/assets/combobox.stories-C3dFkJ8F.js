import{b as x,a as A}from"./utils-DWCsNc5l.js";import{t as g}from"./storybook-code-source-CCz6reEH.js";import{_ as b}from"./index-OZyYlOmW.js";import{v as B,b as S,_ as C,c as v}from"./defineComponent-B-Bg3Ud2.js";import{a as e}from"./attr-tag-Dvq4QMvY.js";import{_ as w}from"./of-fallback-DrWEmKV1.js";import{_ as u}from"./render-tag-B9T2mz-j.js";import{_ as G}from"./const-element-Ea3wmYuQ.js";import{_ as E}from"./index-CWN5kzWH.js";/* empty css                    */import"./index-Qtpjd4O_.js";import"./dynamic-tag-B3Rndxlm.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./style-value-D9hyxyYb.js";import"./index-ClhuoyEP.js";import"./index-Ktyjf5Jd.js";import"./index-CNiudnPv.js";import"./dynamic-import-DdmK3sM_.js";import"./index-CJDBRdqY.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BVXY2btv.js";import"./index-eAGEw84U.js";import"./index-CL8ZzwFK.js";/* empty css             */const L=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        ebay-combobox
    </span>
...
class {
    ...
    async inputChange(e: {
        currentInputValue: ComboboxInput["value"];
    ...
    async searchCountry(currentInputValue: ComboboxInput["value"]): Promise<
        Array<{
            code: string;
            name: string;
        }>
...
`,h="v3$sKaF",s=B.t(h),N=G("label",{for:"my-test-label"},1).t("My label");S.r(h,()=>s);const O={onCreate(){this.state={value:"Basic Offer 22"}},handleClear(){this.state.value=""},handleSelect(a){this.state.value=a.selectedOption?.text||""}};s._=C(function(a,o,i,m,c,M){o.n(N,m),u(b,e.i(()=>{e.a("button",{ariaLabel:"Toggle autocomplete",renderBody:d=>{u(E,{},d,i,"1")}}),e.r("option",{text:"August Campaign"}),e.r("option",{text:"4th of July Sale (paused)"}),e.r("option",{text:"Basic Offer"}),e.r("option",{text:"Basic Offer 1"}),e.r("option",{text:"Basic Offer 3"}),e.r("option",{text:"Basic Offer 11"}),e.r("option",{text:"Basic Offer 12"}),e.r("option",{text:"Basic Offer 13"}),e.r("option",{text:"Basic Offer 14"}),e.r("option",{text:"Basic Offer 15"}),e.r("option",{text:"Basic Offer 16"}),e.r("option",{text:"Basic Offer 17"}),e.r("option",{text:"Basic Offer 18"}),e.r("option",{text:"Basic Offer 19"}),e.r("option",{text:"Basic Offer 20"}),e.r("option",{text:"Basic Offer 21"}),e.r("option",{text:"Basic Offer 22"}),e.r("option",{text:"Basic Offer 23"}),e.r("option",{text:"Basic Offer 24"}),e.r("option",{text:"Basic Offer 25"})},{id:"my-test-label",name:"example2text",value:c.value,autocomplete:"list"}),o,i,"@combobox",[["button-click","handleClear",!1],["select","handleSelect",!1]])},{t:h},O);s.Component=v(O,s._);const R=`import type { ComboboxEvent } from "../component";
class {
    declare state: {
        value: string;
    };
...
<ebay-combobox
    ...
    <@option text="Basic Offer 11"/>
    <@option text="Basic Offer 12"/>
    <@option text="Basic Offer 13"/>
    <@option text="Basic Offer 14"/>
    <@option text="Basic Offer 15"/>
    <@option text="Basic Offer 16"/>
    <@option text="Basic Offer 17"/>
    <@option text="Basic Offer 18"/>
    <@option text="Basic Offer 19"/>
    <@option text="Basic Offer 20"/>
    <@option text="Basic Offer 21"/>
    <@option text="Basic Offer 22"/>
    <@option text="Basic Offer 23"/>
    <@option text="Basic Offer 24"/>
    <@option text="Basic Offer 25"/>
</ebay-combobox>
`,T=a=>({input:A(a)}),ce={title:"form input/ebay-combobox",component:b,parameters:{docs:{description:{component:L}}},argTypes:{name:{control:{type:"text"},description:"used for the `name` attribute of the `<input>` element"},borderless:{type:"boolean",control:{type:"boolean"},description:"whether button has borders "},disabled:{type:"boolean",control:{type:"boolean"},description:"sets the disabled attribute of the input"},expanded:{control:{type:"boolean"},description:"sets whether the listbox is expanded"},autocomplete:{control:{type:"text"},description:"default is `none`; available values are `none` or `list`. For list, will automatically filter results while typing."},listSelection:{control:{type:"text"},description:"default is `automatic`; available values are `automatic`, `manual`. If set to automatic will automatically fill in the input with the currently highlighted item when using the up/down keys."},floatingLabel:{control:{type:"text"},description:"The label to show on the combobox which moves up when focused"},dropdownElement:{description:"For internal use only. Used when combobox container changes. Returns the dropdown element to be used for the combobox",table:{category:"Internal"}},button:{name:"@button",description:"Button element configuration"},fluid:{control:{type:"boolean"},type:"boolean",description:"If true, combobox will span the entire width of it's container"},option:{name:"@option",table:{category:"@attribute tags"}},text:{description:"string to use in the option",control:{type:"text"},table:{category:"@option attributes"}},sticky:{control:{type:"boolean"},type:"boolean",table:{category:"@option attributes"},description:"If true, the option will always be shown even if it does not match the filter"},strategy:{control:{type:"select"},options:["absolute","fixed"],table:{defaultValue:{summary:"absolute"}},description:"Swap between fixed and absolute positioning strategy. Use fixed when dropdown is in contained in an overflow and needs to be visible as you scroll the screen."},flip:{control:{type:"boolean"},table:{defaultValue:{summary:"false"}},description:"Adds flip to dropdown middleware. This allows the dropdown to flip automatically if it overflows"},onCollapse:{action:"on-collapse",table:{category:"Events"},description:" collapsed content"},onExpand:{action:"on-expand",table:{category:"Events"},description:" expanded content"},onChange:{action:"on-change",table:{category:"Events",defaultValue:{summary:"{ el, index, selected }"}},description:"same as the `onChange` event, which fires on blur"},"onInput-change":{action:"on-input-change",table:{category:"Events",defaultValue:{summary:"{ el, index, selected }"}},description:"same as the `onInput` event, which fires with every keypress"},onSelect:{action:"on-select",table:{category:"Events",defaultValue:{summary:"{ el, index, selected }"}},description:"similar to a `<select>`, which fires when an option is clicked or selected"},"onFloating-label-init":{action:"on-floating-label-init",table:{category:"Events",defaultValue:{summary:"{ el, index, selected }"}},description:"when floating label finishes initializing"},onFocus:{action:"on-focus",table:{category:"Events",defaultValue:{summary:"{ el, index, selected }"}},description:"same as the `onFocus` event, which fires on focus"}}},n=T.bind({});n.args={name:"example1text",autocomplete:"list",value:"",option:[{text:"August Campaign"},{text:"4th of July Sale (paused)"},{text:"Basic Offer"},{text:"Basic Offer 2"},{text:"Basic Offer 3"},{text:"Basic Offer 4"}],floatingLabel:"Default Label"};n.parameters={docs:{source:{code:g("ebay-combobox",n.args,{options:"option"})}},expanded:{table:{category:"disabled"}}};const t=T.bind({});t.args={name:"example1text",autocomplete:"list",option:[{text:"August Campaign",value:"1"},{text:"4th of July Sale (paused)",value:"2"},{text:"Basic Offer",value:"3"},{text:"Basic Offer 2",value:"4"},{text:"Basic Offer 3",value:"5"},{text:"Basic Offer 4",value:"6"}]};t.parameters={docs:{source:{code:g("ebay-combobox",t.args,{options:"option"})}},expanded:{table:{category:"disabled"}}};const l=x(r,k),p=x(s,R);n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: Input) => ({
  input: addRenderBodies(args)
})`,...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`(args: Input) => ({
  input: addRenderBodies(args)
})`,...t.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"buildExtensionTemplate(SearchFilteringTemplate, SearchFilteringTemplateCode)",...l.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:"buildExtensionTemplate(ActionableButtonTemplate, ActionableButtonTemplateCode)",...p.parameters?.docs?.source}}};const re=["FloatingLabel","Isolated","SearchFiltering","ActionableButton"];export{p as ActionableButton,n as FloatingLabel,t as Isolated,l as SearchFiltering,re as __namedExportsOrder,ce as default};
