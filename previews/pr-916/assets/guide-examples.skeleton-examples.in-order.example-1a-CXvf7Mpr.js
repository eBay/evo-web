import{_ as e,i as t}from"./_Dk75l5Ev.js";import"./_womTv-gA.js";e("dbnxnc3",a=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},1750)}));t();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order.example-1a-CXvf7Mpr.js.map
