import{_ as e,i as a}from"./_Dk75l5Ev.js";import"./_womTv-gA.js";e("tWSMR4o",t=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},500),setTimeout(()=>{document.querySelector("main").innerHTML+=`
      ...
      `},3500),setTimeout(()=>{document.querySelector("aside").innerHTML+=`
      ...
      <section id="section-2">
        <h2>Archives</h2>
        <p>Etiam porta sem malesuada magna mollis euismod. Cras mattis consectetur purus sit amet fermentum. Aenean lacinia bibendum nulla sed consectetur.</p>
    </section>`},3750),setTimeout(()=>{document.body.innerHTML+=`
    ...
    `},4e3)}));a();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order.example-2a-B0mL3bfZ.js.map
