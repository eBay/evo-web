import{_ as e,i as t}from"./_Dk75l5Ev.js";import"./_womTv-gA.js";e("Erz$CMU",i=>window.addEventListener("load",()=>{document.querySelector("button").addEventListener("click",function(s){document.querySelector("main").innerHTML=`
    ...
    `,setTimeout(()=>{document.querySelector(".skeleton").hidden=!0,document.querySelector("button").disabled=!0,document.querySelector("main").innerHTML=`
      ...
      `},3e3)})}));t();
//# sourceMappingURL=guide-examples.skeleton-examples.csr.example-3-BgC95cUW.js.map
