...
&lt;/a&gt;
  ...
  &gt;&lt;/span&gt;
&lt;/a&gt;
</code></pre><h2>References</h2><ul><li><a>Component Pattern : Link</a></li><li><a>Technique: Clipped Text</a></li></ul></div>`,i=`DvaE lD n`;function a(t){e(t.a,`href`,`${n.components}/link`),e(t.b,`href`,`${n.accessibility}/techniques/offscreen-text`)}var o=t(`Md`,r,i,a);export{a as $setup,r as $template,i as $walks,o as default};
//# sourceMappingURL=_BUukhe1r.js.map