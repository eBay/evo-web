import{_ as e,i as t}from"./_DRgDtfix.js";import"./_DXz42RnE.js";e("FHHZ2si",a=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},200),setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <article id="hero">
    ...
    `},250),setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <main>
    ...
    `},250),setTimeout(()=>{document.querySelector("main .demo-skeleton").hidden=!0,document.querySelector("main").innerHTML+=`
      <article>
    ...
    `},1e3),setTimeout(()=>{document.querySelector("#section-2").innerHTML=`
      <h2>Archives</h2>
      <p>Etiam porta sem malesuada magna mollis euismod. Cras mattis consectetur purus sit amet fermentum. Aenean lacinia bibendum nulla sed consectetur.</p>
    `},1500),setTimeout(()=>{document.body.innerHTML+=`
    ...
    `},1750)}));t();
//# sourceMappingURL=guide-examples.skeleton-examples.out-of-order.example-4-CZWVTtda.js.map
