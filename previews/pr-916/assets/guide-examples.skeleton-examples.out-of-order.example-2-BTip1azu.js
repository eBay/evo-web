import{_ as e,i as a}from"./_DRgDtfix.js";import"./_DXz42RnE.js";e("kh_wIfq",t=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},500),setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <main>
    ...
    `},550),setTimeout(()=>{document.querySelector("main .demo-skeleton").hidden=!0,document.querySelector("main").innerHTML+=`
      <article>
      ...
      `},3e3),setTimeout(()=>{document.querySelector("aside").innerHTML+=`
      ...
      <section id="section-2">
        <h2>Archives</h2>
        <p>Etiam porta sem malesuada magna mollis euismod. Cras mattis consectetur purus sit amet fermentum. Aenean lacinia bibendum nulla sed consectetur.</p>
    </section>`},750),setTimeout(()=>{document.body.innerHTML+=`
    ...
    `},750)}));a();
//# sourceMappingURL=guide-examples.skeleton-examples.out-of-order.example-2-BTip1azu.js.map
