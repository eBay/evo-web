import{_ as e,i as a}from"./_DRgDtfix.js";import"./_DXz42RnE.js";e("rdJ6_Uw",t=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},250),setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      ...
      <aside></aside>
    `},500),setTimeout(()=>{document.querySelector("main").innerHTML+=`
      <article>
    ...
    `},750)}));a();
//# sourceMappingURL=guide-examples.skeleton-examples.out-of-order.example-1-B6Yq20xa.js.map
