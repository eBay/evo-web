import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./utils-CkiB0p9L.js";import{A as n,i as r,t as i}from"./dom-DAi6NM7T.js";import{a,c as o,i as s,n as c,o as l,r as u,s as d,t as f}from"./evo-badge-DxuJ-hYH.js";var p;function m(){return(m=e((()=>{p=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        evo-badge
    </span>
...
`})))()}var h,g,_,v,y,b;function x(){return(x=e((()=>{o(),r(),h=(e=>`<!>${e}<!>`)(a),g=(e=>`b/${e}&b`)(`b%c`),_=(e,t)=>f(e.a,t),v=(e,t)=>{s(e.a,t),_(e,`${t} unread items`)},y=n(2,e=>{u(e.a,e.c.class),l(e.a,e.c.type),c(e.a,(({a11yText:e,class:t,number:n,type:r,...i})=>i)(e.c)),v(e,e.c.number)}),b=i(`DT3qf32`,h,g,0,y)})))()}var S;function C(){return(C=e((()=>{S=`import type { Input as BadgeInput } from "../index.marko";
...
`})))()}function w(e){f(e.a,`new`),u(e.a),s(e.a),l(e.a),c(e.a,{})}var T,E,D;function O(){return(O=e((()=>{o(),r(),T=(e=>`<!>${e}<!>`)(a),E=(e=>`b/${e}&b`)(`b%c`),D=i(`qWKZ9v2`,T,E,w)})))()}var k;function A(){return(A=e((()=>{k=`<evo-badge a11yText="new"/>
