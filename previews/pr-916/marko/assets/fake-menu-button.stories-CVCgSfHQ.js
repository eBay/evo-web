import{b as i}from"./utils-DyU2_5R1.js";import{b as e,_ as s,Z as n,S as a}from"./dom-8p8ib85z.js";import{a as r,$ as l,c as m,b as c,C as h}from"./index-jLEIph_J.js";import{$,a as y,b as g,c as v}from"./evo-icon-settings-24-CvBm5JgO.js";import{$ as k,a as w,b as T,c as _}from"./evo-icon-overflow-vertical-16-BdCuEHe3.js";import"./iframe-BjWUPQEW.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DmjU8DIO.js";import"./index-Ct-qxVYw.js";import"./index-D0OAQvSv.js";import"./index-D6p3sHt8.js";import"./evo-icon-chevron-down-16-DPmlMeiv.js";import"./index-lx-BNJUr.js";import"./controllable.feat-Dk0q4jHd.js";import"./controllable-input.feat-C1Sej8QJ.js";import"./controllable-open.feat-DYGsRGgr.js";import"./controllable-select.feat-QgsxkUw8.js";/* empty css                    */import"./index-DpqAMYfc.js";import"./evo-icon-tick-16-CiruzTKq.js";/* empty css             */import"./index-DMHEs1H6.js";import"./evo-icon-chevron-down-12-BXFr2edo.js";/* empty css                    */const x=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
...
`,S=r,C=(t=>`/${t}&`)(c),L=e("ItkS$Nk","item 3"),E=e("$Rg$sk5","item 2"),W=e("Actsz4K","item 1"),A=e("v5Gpcwl","eBay Menu");function B(t){m(t.a)}const D=(t,o)=>l(t.a,{...o,item:n(n(a({href:"#",content:W(t)}),{type:"button",content:E(t)}),{href:"#",content:L(t)}),content:A(t)}),M=s("iSSiHAa",S,C,B,D),R=`<evo-fake-menu-button ...input>
  <@item href="#">
    item 1
  </@item>
  <@item type="button">
...
`,z=r,O=(t=>`/${t}&`)(c),H=e("fdL54$n","item 3"),I=e("Uz_sSP4","item 2"),U=e("TVLl3S5","item 1"),V=t=>{g(t.a),v(t.a,{})},N=e("kBZuUQr",(t=>`Settings ${t}`)(y),(t=>`b/${t}&`)($),V);function Z(t){m(t.a)}const q=(t,o)=>l(t.a,{...o,item:n(n(a({type:"button",content:U(t)}),{type:"button",content:I(t)}),{type:"button",content:H(t)}),content:N(t)}),P=s("cQN$2DW",z,O,Z,q),K=`<evo-fake-menu-button ...input>
  <@item type="button">
    item 1
  </@item>
  <@item type="button">
...
`,Q=r,j=(t=>`/${t}&`)(c),F=e("GvcQB9D","item 3"),G=e("BK$POqW","item 2"),J=e("PR6Awlf","item 1 that has very long text"),X=e("BpZa6rS","<span class=custom-label-flag></span>"),Y=e("CDjZzT4","This is the label you first see");function tt(t){m(t.a)}const et=(t,o)=>l(t.a,{...o,label:a({content:X(t)}),item:n(n(a({href:"#",content:J(t)}),{href:"#",content:G(t)}),{href:"#",content:F(t)}),content:Y(t)}),nt=s("E6nvalR",Q,j,tt,et),ot=`<style>
...
`,at=r,it=(t=>`/${t}&`)(c),st=e("Sens0AS","item 4"),rt=e("qazCWoD","item 3"),lt=e("N6id1$8","item 2"),mt=e("Vu1R_6$","item 1"),ct=e("RZsCEiL","eBay Menu separator");function pt(t){m(t.a)}const ut=(t,o)=>l(t.a,{...o,item:n(n(n(n(a({href:"#",content:mt(t)}),{href:"#",content:lt(t)}),{separator:!0}),{href:"#",content:rt(t)}),{href:"#",content:st(t)}),content:ct(t)}),bt=s("Vq698wL",at,it,pt,ut),dt=`<evo-fake-menu-button ...input>
  <@item href="#">
    item 1
  </@item>
  <@item href="#">
...
`,ft=r,ht=(t=>`/${t}&`)(c),$t=e("B9cRmL8","item 3"),yt=e("WdE0Wt0","item 2"),gt=e("u_Aq_x4","item 1"),vt=t=>{T(t.a),_(t.a,{})},kt=e("SOFEbvE",w,(t=>`/${t}&`)(k),vt);function wt(t){m(t.a)}const Tt=(t,o)=>l(t.a,{variant:"icon",a11yText:"eBay Menu",...o,item:n(n(a({href:"#",content:gt(t)}),{href:"#",content:yt(t)}),{href:"#",content:$t(t)}),content:kt(t)}),_t=s("zpTLKUA",ft,ht,wt,Tt),xt=`<evo-fake-menu-button variant="icon" a11yText="eBay Menu" ...input>
  <@item href="#">
    item 1
  </@item>
  <@item href="#">
