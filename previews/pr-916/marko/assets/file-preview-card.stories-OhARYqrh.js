import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./utils-CkiB0p9L.js";import{A as n,N as ee,i as r,n as i,rt as a,t as o}from"./dom-DAi6NM7T.js";import{_ as s,a as c,c as l,d as u,f as d,g as f,h as p,i as m,l as h,m as g,n as _,o as v,p as y,r as b,s as x,t as S,u as C}from"./evo-file-preview-card-C-9emfkJ.js";var w;function T(){return(T=e((()=>{w=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
...
`})))()}function te(e){b(e.a,i({a11yText:`Delete`,onClick:D})),_(e.a,i({a11yText:`Cancel upload`,onClick:E}))}function E(){console.log(`cancel upload clicked`)}function D(){console.log(`delete clicked`)}var O,k,A,j;function M(){return(M=e((()=>{s(),r(),O=(e=>`<!>${e}<!>`)(p),k=(e=>`b/${e}&b`)(`b%c`),A=n(2,e=>{S(e.a,e.c.action),h(e.a,e.c.as),C(e.a,e.c.class),d(e.a,e.c.file),m(e.a,e.c.footerSubtitle),c(e.a,e.c.footerTitle),v(e.a,e.c.href),l(e.a,e.c.infoText),u(e.a,e.c.menuActions),y(e.a,e.c.seeMoreAction),g(e.a,e.c.status),x(e.a,(({action:e,as:t,cancelAction:n,class:ee,deleteAction:r,file:i,footerSubtitle:a,footerTitle:o,href:s,infoText:c,menuActions:l,seeMoreAction:u,status:d,...f})=>f)(e.c))}),a(`x5Ps2Yq`,E),a(`YNzoXg5`,D),j=o(`c1ZJph5`,O,k,te,A)})))()}var N;function P(){return(P=e((()=>{N=`<evo-file-preview-card ...input>
  <@deleteAction
    a11yText="Delete"
    onClick() {
...
`})))()}function ne(e){_(e.a,i({a11yText:`Cancel upload`,onClick:I})),b(e.a,i({a11yText:`Delete`,onClick:F})),y(e.a,i({a11yText:null,content:z(e)}))}function F(){console.log(`delete clicked`)}function I(){console.log(`cancel upload clicked`)}var L,R,z,B,V;function H(){return(H=e((()=>{s(),r(),L=(e=>`<!>${e}<!>`)(p),R=(e=>`b/${e}&b`)(`b%c`),z=ee(`Pd2nZc7`,`+15`),B=n(2,e=>{let t={file:{name:`file-name.jpg`,type:`image/jpeg`,src:`https://ir.ebaystatic.com/cr/v/c01/skin/docs/tb-real-square-pic.jpg`},...e.c};S(e.a,t.action),h(e.a,t.as),C(e.a,t.class),d(e.a,t.file),m(e.a,t.footerSubtitle),c(e.a,t.footerTitle),v(e.a,t.href),l(e.a,t.infoText),u(e.a,t.menuActions),g(e.a,t.status),x(e.a,(({action:e,as:t,cancelAction:n,class:ee,deleteAction:r,file:i,footerSubtitle:a,footerTitle:o,href:s,infoText:c,menuActions:l,seeMoreAction:u,status:d,...f})=>f)(t))}),a(`vykV1oW`,F),a(`pnk2IpE`,I),V=o(`KC$p4sl`,L,R,ne,B)})))()}var U;function W(){return(W=e((()=>{U=`<evo-file-preview-card
  file={
    name: "file-name.jpg",
    type: "image/jpeg",
