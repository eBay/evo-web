import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./utils-CkiB0p9L.js";import{N as n,i as r,t as i}from"./dom-DAi6NM7T.js";import{i as a,n as o,r as s,t as c}from"./evo-icon-button-PqXv2_d4.js";import{a as l,i as u,n as d,r as f,t as p}from"./evo-icon-menu-24-mKYysC80.js";var m,h,g,_,v,y;function b(){return(b=e((()=>{l(),a(),r(),m=(e=>`<!>${e}<!>`)(o),h=(e=>`b/${e}&b`)(`b%c`),g=e=>{d(e.a),p(e.a,{})},_=n(`rVusg23`,f,(e=>`/${e}&`)(u),g),v=(e,t)=>c(e.a,{a11yText:`Menu`,...t,content:_(e)}),y=i(`E86Pxgv`,m,h,0,v)})))()}var x;function S(){return(S=e((()=>{x=`<evo-icon-button a11yText="Menu" ...input>
  <evo-icon-menu-24/>
</evo-icon-button>
`})))()}var C;function w(){return(w=e((()=>{C=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        evo-icon-button
    </span>
