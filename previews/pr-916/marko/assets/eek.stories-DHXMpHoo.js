import{_ as N,f as B,g as $,w as p,N as Z,i as nn,l as an,m as Q,h as tn}from"./dom-BCmBFxnG.js";import{$ as Y,a as o,b as s,c}from"./index-DV0LQG27.js";import"./iframe-neL4uaf-.js";import"./preload-helper-PPVm8Dsz.js";function V(n,E,G={},x="",l=!1){const d=x+"	",{body:v,attrs:u}=gn(E,G,d);let k=n;return l&&(k=`@${G[k]||k}`),`<${k+u+(v?`>
${v.replace(/^|\n/gm,`$&${d}`)}
