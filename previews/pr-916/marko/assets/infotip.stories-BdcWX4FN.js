import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./utils-CkiB0p9L.js";import{A as ee,N as n,Q as te,i as r,j as i,n as a,nt as ne,rt as re,t as o}from"./dom-DAi6NM7T.js";import{i as ie,n as ae,o as oe,r as se,t as ce}from"./evo-button-CynZwStY.js";import{a as le,c as s,d as c,i as ue,l,n as de,o as u,r as fe,s as d,t as pe,u as me}from"./evo-icon-help-24-6sAl4dWQ.js";function he(e){d(e.a)}var f,p,m,h,g,_;function v(){return(v=e((()=>{c(),r(),f=s,p=(e=>`/${e}&`)(l),m=n(`nvow$CL`,`Important`),h=i(`gYPeX$C`,`This is some important info about this feature.`),g=(e,t)=>u(e.a,{...t,a11yIconText:`Important information`,a11yCloseText:`Dismiss infotip`,heading:a({content:m(e)}),content:h(e)}),_=o(`$zi5wRB`,f,p,he,g)})))()}var y;function b(){return(b=e((()=>{y=`<evo-infotip
  ...input
...
`})))()}function ge(e){d(e.a)}var x,S,C,w,T;function E(){return(E=e((()=>{c(),r(),x=(e=>`<p>Here is some text with an info icon ${e} and the paragraph continues.</p>`)(s),S=(e=>`Db/${e}&l`)(l),C=i(`V$XCaW3`,`This provides additional context about the text.`),w=(e,t)=>u(e.a,{...t,a11yIconText:`More information`,a11yCloseText:`Dismiss`,content:C(e)}),T=o(`vHp2tyH`,x,S,ge,w)})))()}var D;function O(){return(O=e((()=>{D=`<p>
...
`})))()}function _e(e){d(e.a)}var k,A,j,M,N,P;function F(){return(F=e((()=>{c(),r(),k=s,A=(e=>`/${e}&`)(l),j=n(`YxFOayT`,`Disabled`),M=i(`f_pDva2`,`This infotip is disabled.`),N=(e,t)=>u(e.a,{...t,disabled:!0,a11yIconText:`Help`,a11yCloseText:`Dismiss`,heading:a({content:j(e)}),content:M(e)}),P=o(`A8a7ObW`,k,A,_e,N)})))()}var I;function L(){return(L=e((()=>{I=`<evo-infotip ...input disabled a11yIconText="Help" a11yCloseText="Dismiss">
  <@heading>Disabled</@heading>
  This infotip is disabled.
</evo-infotip>
`})))()}function ve(e){d(e.a)}var R,z,B,V,H,U,ye,be;function xe(){return(xe=e((()=>{le(),c(),r(),R=s,z=(e=>`/${e}&`)(l),B=n(`mI_1D4L`,`Shipping Info`),V=e=>{de(e.a),pe(e.a,{})},H=n(`kHcspDN`,fe,(e=>`/${e}&`)(ue),V),U=i(`LiSG8fb`,`Free shipping on orders over $50.`),ye=(e,t)=>u(e.a,{...t,a11yIconText:`Help with shipping`,a11yCloseText:`Dismiss`,icon:a({content:H(e)}),heading:a({content:B(e)}),content:U(e)}),be=o(`uQ1yvSx`,R,z,ve,ye)})))()}var Se;function Ce(){return(Ce=e((()=>{Se=`<evo-infotip ...input a11yIconText="Help with shipping" a11yCloseText="Dismiss">
  <@icon>
    <evo-icon-help-24/>
  </@icon>
...
`})))()}function we(e){ae(e.a),d(e.b),G(e,!1)}var Te,Ee,De,Oe,ke,W,G,Ae,K,q,je;function Me(){return(Me=e((()=>{oe(),c(),r(),Te=((e,t)=>`<!>${e}${t}`)(se,s),Ee=((e,t)=>`b/${e}&/${t}&`)(ie,l),De=n(`We1dA8e`,`Controlled`),Oe=i(`uMYDkJb`,`This infotip is controlled externally.`),ke=n(`MuhZp$B`,`Toggle Infotip`),W=ne(5,e=>u(e.b,{...e.d,open:e.e,openChange:K(e),a11yIconText:`Help`,a11yCloseText:`Dismiss`,heading:a({content:De(e)}),content:Oe(e)})),G=te(4,e=>{ce(e.a,{onClick:q(e),content:ke(e)}),W(e)}),Ae=ee(3,W),K=e=>t=>{G(e,t)},q=e=>function(){G(e,!e.e)},re(`xPFKGFQ`,K),re(`bwBa$VP`,q),je=o(`qaoAcQm`,Te,Ee,we,Ae)})))()}var Ne;function Pe(){return(Pe=e((()=>{Ne=`<let/open=false>
