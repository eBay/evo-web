...
\`\`\``}}}},g=e=>(0,m.jsxs)(o,{...e,children:[(0,m.jsx)(a,{text:`August Campaign`}),(0,m.jsx)(a,{text:`4th of July Sale (paused)`}),(0,m.jsx)(a,{text:`Basic Offer`}),(0,m.jsx)(a,{text:`Basic Offer 1`}),(0,m.jsx)(a,{text:`Basic Offer 2`})]}),_=e=>(0,m.jsxs)(o,{...e,floatingLabel:e.floatingLabel||`Default Label`,children:[(0,m.jsx)(a,{text:`August Campaign`}),(0,m.jsx)(a,{text:`4th of July Sale (paused)`}),(0,m.jsx)(a,{text:`Basic Offer`}),(0,m.jsx)(a,{text:`Basic Offer 1`}),(0,m.jsx)(a,{text:`Basic Offer 2`})]}),v=e=>(0,m.jsxs)(o,{...e,autocomplete:`list`,children:[(0,m.jsx)(a,{text:`August Campaign`}),(0,m.jsx)(a,{text:`4th of July Sale (paused)`}),(0,m.jsx)(a,{text:`Basic Offer`}),(0,m.jsx)(a,{text:`Basic Offer 1`}),(0,m.jsx)(a,{text:`Basic Offer 2`})]}),y=e=>{let[t,n]=p.useState(d),[r,i]=p.useState(`none`),[c,l]=p.useState(``),f=p.useRef(),h=e=>new Promise(t=>{clearTimeout(f.current),f.current=setTimeout(()=>{t(d.filter(t=>t.name.toLowerCase().startsWith(e.toLowerCase())).slice(0,10))},500)}),g=async(e,t)=>{i(`none`),l(t?.currentInputValue||``);let r=await h(t?.currentInputValue||``);n(r),i(`list`)},_=(e,t)=>{l(t.currentInputValue)};return(0,m.jsxs)(o,{...e,name:`country`,autocomplete:r,value:c,onInputChange:g,onSelect:_,children:[(0,m.jsx)(s,{onClick:()=>l(``),children:(0,m.jsx)(u,{})}),t.map(e=>(0,m.jsx)(a,{text:e.name,value:e.code},e.name))]})},b=[`Default`,`FloatingLabel`,`AutomaticallyFilterResults`,`SearchFiltering`],g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`args => <EbayCombobox {...args}>
    ...
    </EbayCombobox>`,...g.parameters?.docs?.source}}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`args => <EbayCombobox {...args} floatingLabel={args.floatingLabel || "Default Label"}>
        <EbayComboboxOption text="August Campaign" />
        <EbayComboboxOption text="4th of July Sale (paused)" />
        <EbayComboboxOption text="Basic Offer" />
        <EbayComboboxOption text="Basic Offer 1" />
        <EbayComboboxOption text="Basic Offer 2" />
    </EbayCombobox>`,..._.parameters?.docs?.source}}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`args => <EbayCombobox {...args} autocomplete="list">
        <EbayComboboxOption text="August Campaign" />
        <EbayComboboxOption text="4th of July Sale (paused)" />
        <EbayComboboxOption text="Basic Offer" />
        <EbayComboboxOption text="Basic Offer 1" />
        <EbayComboboxOption text="Basic Offer 2" />
    </EbayCombobox>`,...v.parameters?.docs?.source}}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`args => {
...
}`,...y.parameters?.docs?.source}}}})))()}x();export{v as AutomaticallyFilterResults,g as Default,_ as FloatingLabel,y as SearchFiltering,b as __namedExportsOrder,h as default};