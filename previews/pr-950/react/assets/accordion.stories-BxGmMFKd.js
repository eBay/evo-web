...
}`,...H.parameters?.docs?.source},description:{story:`Multiple selection allows several sections to remain open.`,...H.parameters?.docs?.description}}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  args: {
    open: "0"
  },
...
}`,...U.parameters?.docs?.source},description:{story:`Controlled state synchronizes the open item with the parent.`,...U.parameters?.docs?.description}}},W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`{
  render(args) {
...
}`,...W.parameters?.docs?.source},description:{story:`Leading icons provide a decorative cue for each section.`,...W.parameters?.docs?.description}}}})))()}K();export{U as Controlled,V as Default,H as MultipleSelection,W as WithLeadingIcon,G as __namedExportsOrder,B as default};