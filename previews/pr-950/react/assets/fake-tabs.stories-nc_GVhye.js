...
\`\`\`
`}}},render(e){let t=({href:e,children:t,...n})=>(0,O.jsx)(`a`,{"data-router-link":`true`,href:e,...n,children:t});return(0,O.jsxs)(w,{...e,children:[(0,O.jsxs)(g,{children:[(0,O.jsx)(f,{id:`overview`,href:`/overview`,as:t,children:`Overview`}),(0,O.jsx)(f,{id:`shipping`,href:`/shipping`,as:t,children:`Shipping`})]}),(0,O.jsx)(b,{children:(0,O.jsx)(`p`,{children:`Content rendered by the router.`})})]})}},M=[`Default`,`CustomLink`],A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{}`,...A.parameters?.docs?.source},description:{story:`The selected link reflects the current URL beside an unavailable tab.`,...A.parameters?.docs?.description}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
