...
\`\`\``}}}},m=n(o=>e.createElement(i,{...o},e.createElement(a,{text:"August Campaign"}),e.createElement(a,{text:"4th of July Sale (paused)"}),e.createElement(a,{text:"Basic Offer"}),e.createElement(a,{text:"Basic Offer 1"}),e.createElement(a,{text:"Basic Offer 2"})),"Default"),r=n(o=>e.createElement(i,{...o,floatingLabel:o.floatingLabel||"Default Label"},e.createElement(a,{text:"August Campaign"}),e.createElement(a,{text:"4th of July Sale (paused)"}),e.createElement(a,{text:"Basic Offer"}),e.createElement(a,{text:"Basic Offer 1"}),e.createElement(a,{text:"Basic Offer 2"})),"FloatingLabel"),d=n(o=>e.createElement(i,{...o,autocomplete:"list"},e.createElement(a,{text:"August Campaign"}),e.createElement(a,{text:"4th of July Sale (paused)"}),e.createElement(a,{text:"Basic Offer"}),e.createElement(a,{text:"Basic Offer 1"}),e.createElement(a,{text:"Basic Offer 2"})),"AutomaticallyFilterResults"),s=n(o=>{const[l,h]=e.useState(C),[f,p]=e.useState("none"),[g,u]=e.useState(""),y=e.useRef(),E=n(t=>new Promise(c=>{clearTimeout(y.current),y.current=setTimeout(()=>{const b=C.filter(I=>I.name.toLowerCase().startsWith(t.toLowerCase())).slice(0,10);c(b)},500)}),"searchCountry"),S=n(async(t,c)=>{p("none"),u(c?.currentInputValue||"");const b=await E(c?.currentInputValue||"");h(b),p("list")},"handleInputChange"),x=n((t,c)=>{u(c.currentInputValue)},"handleSelect");return e.createElement(i,{...o,name:"country",autocomplete:f,value:g,onInputChange:S,onSelect:x},e.createElement(B,{onClick:n(()=>u(""),"onClick")},e.createElement(M,null)),l.map(t=>e.createElement(a,{key:t.name,text:t.name,value:t.code})))},"SearchFiltering");m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`args => <EbayCombobox {...args}>
    ...
    </EbayCombobox>`,...m.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`args => <EbayCombobox {...args} floatingLabel={args.floatingLabel || "Default Label"}>
        <EbayComboboxOption text="August Campaign" />
        <EbayComboboxOption text="4th of July Sale (paused)" />
        <EbayComboboxOption text="Basic Offer" />
        <EbayComboboxOption text="Basic Offer 1" />
        <EbayComboboxOption text="Basic Offer 2" />
    </EbayCombobox>`,...r.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`args => <EbayCombobox {...args} autocomplete="list">
        <EbayComboboxOption text="August Campaign" />
        <EbayComboboxOption text="4th of July Sale (paused)" />
        <EbayComboboxOption text="Basic Offer" />
        <EbayComboboxOption text="Basic Offer 1" />
        <EbayComboboxOption text="Basic Offer 2" />
    </EbayCombobox>`,...d.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`args => {
...
}`,...s.parameters?.docs?.source}}};const z=["Default","FloatingLabel","AutomaticallyFilterResults","SearchFiltering"];export{d as AutomaticallyFilterResults,m as Default,r as FloatingLabel,s as SearchFiltering,z as __namedExportsOrder,Z as default};
