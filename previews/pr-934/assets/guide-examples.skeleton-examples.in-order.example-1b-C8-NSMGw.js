import{_ as e,i as a}from"./_BVUlZabi.js";import"./_DDxTVbc5.js";e("H815CsS",t=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
  ...
  <main>
    ...
    `},3750)}));a();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order.example-1b-C8-NSMGw.js.map
