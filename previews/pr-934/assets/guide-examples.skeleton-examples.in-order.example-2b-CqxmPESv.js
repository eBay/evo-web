import{_ as e,i as a}from"./_BVUlZabi.js";import"./_DDxTVbc5.js";e("Lq18id5",t=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},500),setTimeout(()=>{document.querySelector("main").innerHTML+=`
      ...
      </aside>`},3500),setTimeout(()=>{document.body.innerHTML+=`
    ...
    `},3750)}));a();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order.example-2b-CqxmPESv.js.map
