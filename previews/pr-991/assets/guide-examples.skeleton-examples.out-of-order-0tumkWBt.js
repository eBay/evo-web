import{C as e,v as t}from"./_XkvwCyHu.js";import"./_C5Dh7mzz.js";t(`H2mS8JV`,e=>window.addEventListener(`load`,()=>{setTimeout(()=>{document.querySelector(`.page-grid`).innerHTML+=`
      <nav>
    ...
    `},500)})),e();
//# sourceMappingURL=guide-examples.skeleton-examples.out-of-order-0tumkWBt.js.map