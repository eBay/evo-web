...
`,r=n=>({input:{...n,renderBody:n.renderBody?t=>{t.html(n.renderBody)}:null}}),d={title:"graphics & icons/ebay-signal",component:o,parameters:{docs:{description:{component:s}}},argTypes:{status:{type:"enum",control:{type:"select"},options:["trustworthy","recent","time-sensitive","neutral"]}}},e=r.bind({});e.args={renderBody:"Signal Text"};e.parameters={docs:{source:{code:a("ebay-signal",e.args)}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`(args: Input) => ({
  input: {
    ...args,
...
})`,...e.parameters?.docs?.source}}};const l=["Standard"];export{e as Standard,l as __namedExportsOrder,d as default};
