import{b as i}from"./utils-DyU2_5R1.js";import{a as l,_ as c,l as r}from"./dom-B_aQtK5Z.js";import{c as n,$ as o,a,b as s,I as C}from"./index-dKT3foy1.js";import{$ as v,a as I,b as T,c as _,d as L,e as w,f as y,g as W,h as E,i as k,j as D,k as F}from"./evo-icon-mail-24-DBlQMkLb.js";import"./iframe-DMl2D3CN.js";import"./preload-helper-PPVm8Dsz.js";import"./controllable-input.feat-BWTl2t6G.js";import"./controllable.feat-CmDpOgp5.js";import"./controllable-open.feat-Co2vF3JB.js";import"./controllable-select.feat-BWENUZLB.js";import"./index-7YhAHZgL.js";import"./index-fw6h05cN.js";/* empty css                *//* empty css                    */const S=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        evo-input
    </span>
...
`,A=(e=>`<!>${e}<!>`)(s),M=(e=>`b/${e}&b`)(a);function P(e){o(e.a)}const z=(e,t)=>n(e.a,t),H=l("eFVK$Lk",A,M,P,z),B=`<evo-input ...input/>
`,R=(e=>`<span class=field><label class="field__label field__label--start" for=textbox>Email address</label>${e}</span>`)(s),j=(e=>`Db/${e}&l`)(a);function N(e){o(e.a)}const V=(e,t)=>n(e.a,{...t,id:"textbox",value:"test"}),U=l("cd5vAMj",R,j,N,V),q=`<span class="field">
...
`,O=(e=>`<span class=field><label class="field__label field__label--start field__label--disabled" for=textbox>Email address</label>${e}</span>`)(s),Q=(e=>`Db/${e}&l`)(a);function X(e){o(e.a)}const Z=(e,t)=>n(e.a,{...t,disabled:!0,id:"textbox",value:"test"}),G=l("VfHH5y3",O,Q,X,Z),J=`<span class="field">
    <label
...
`,K=(e=>`<!>${e}<!>`)(s),Y=(e=>`b/${e}&b`)(a);function ee(e){o(e.a)}const te=(e,t)=>n(e.a,{floatingLabel:"Email address",...t}),ne=l("rTQz2lI",K,Y,ee,te),oe=`<evo-input
...
/>
`,pe=(e=>`<!>${e}<!>`)(s),de=(e=>`b/${e}&b`)(a),ue=e=>{L(e.a),w(e.a,{})},me=c("z3d550V",I,(e=>`/${e}&`)(v),ue),be=e=>{y(e.a),W(e.a,{})},fe=c("Q4F02No",_,(e=>`/${e}&`)(T),be);function $e(e){o(e.a)}const xe=(e,t)=>n(e.a,{placeholder:"name",...t,postfixIcon:r({"aria-label":"Clear",content:fe(e)}),prefixIcon:r({content:me(e)})}),he=l("Ohq019T",pe,de,$e,xe),ge=`<evo-input placeholder="name" ...input>
...
`,ve=(e=>`<!>${e}<!>`)(s),Ie=(e=>`b/${e}&b`)(a),Te=e=>{L(e.a),w(e.a,{})},_e=c("iD0MT7Z",I,(e=>`/${e}&`)(v),Te);function Le(e){o(e.a)}const we=(e,t)=>n(e.a,{placeholder:"name",...t,postfixIcon:r({content:_e(e)})}),ye=l("FBaIAuy",ve,Ie,Le,we),We=`<evo-input
    placeholder="name"
    ...input
>
    <@postfixIcon>
...
`,Ee=(e=>`<!>${e}<!>`)(s),ke=(e=>`b/${e}&b`)(a),De=e=>{D(e.a),F(e.a,{})},Fe=c("zzyTlgV",k,(e=>`/${e}&`)(E),De);function Ce(e){o(e.a)}const Se=(e,t)=>n(e.a,{placeholder:"email",...t,prefixIcon:r({content:Fe(e)})}),Ae=l("pMj4WtB",Ee,ke,Ce,Se),Me=`<evo-input
    placeholder="email"
    ...input
>
    <@prefixIcon>
...
`,Pe=(e=>`<!>${e}<!>`)(s),ze=(e=>`b/${e}&b`)(a),He=e=>{y(e.a),W(e.a,{})},Be=c("LdzfSD5",_,(e=>`/${e}&`)(T),He),Re=c("Rv2EXZo","/mo"),je=c("BGe6WjN","$"),Ne=e=>{D(e.a),F(e.a,{})},Ve=c("occmVsw",k,(e=>`/${e}&`)(E),Ne);function Ue(e){o(e.a)}const qe=(e,t)=>n(e.a,{placeholder:"0.00",...t,prefixIcon:r({content:Ve(e)}),prefixText:r({content:je(e)}),postfixText:r({content:Re(e)}),postfixIcon:r({content:Be(e)})}),Oe=l("JRPHMmn",Pe,ze,Ue,qe),Qe=`<evo-input
    placeholder="0.00"
    ...input
>
    <@prefixIcon>
