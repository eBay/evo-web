import{b as w}from"./utils-DyU2_5R1.js";import{a as y,b as n,z as g,f as k,d as _,i as c,r as I,e as b,P as $,_ as r,q as h,v as f}from"./dom-BwDV3QmC.js";import"./iframe-Ca_lldlR.js";import"./preload-helper-PPVm8Dsz.js";const o="<div role=img></div>",s=" b",O=()=>{},S=(t,e)=>I(t.a,"aria-label",e),l=(t,e)=>S(t,e!==void 0?e:"Loading..."),a=(t,e)=>k(t.a,["skeleton",e]),E=_("GPH9OIk",t=>c(t,"a")),i=n(5,t=>{g(t,"a",t.f,{role:1,"aria-label":1,class:1}),E(t)}),A=(t,e)=>{(({a11yText:u,class:v,...d})=>i(t,d))(e),a(t,e.class),l(t,e.a11yText)},D=y("Fyt6AHW",o,s,O,A),C=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        evo-skeleton
    </span>
