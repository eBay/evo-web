import{a as N,b as B,c as $,r as p,x as Z,d as nn,i as an,e as Q,f as tn}from"./dom-TuxgW4Cw.js";import{$ as Y,b as o,c as s,a as c}from"./index-DV25PJpD.js";import"./iframe-CqOKIB7R.js";import"./preload-helper-PPVm8Dsz.js";function V(n,E,G={},x="",l=!1){const d=x+"	",{body:v,attrs:u}=gn(E,G,d);let k=n;return l&&(k=`@${G[k]||k}`),`<${k+u+(v?`>
${v.replace(/^|\n/gm,`$&${d}`)}
