import{b as A}from"./utils-DyU2_5R1.js";import{a as g,b as i,c as P,E as W,d as L,i as B,e as d,f as J,A as K,r as N,u as M,B as U,_ as n,k as c,l as a,U as j,x as F,D as G,C as Q}from"./dom-BBo1hePz.js";import{$ as X,a as Y,b as Z,c as tt,d as et,e as nt,f as it,g as at,h as ot,i as rt,j as ut}from"./index-ZO8AzeLo.js";import"./iframe-DGm0Ux3b.js";import"./preload-helper-PPVm8Dsz.js";import"./controllable-open.feat-DDgkakf1.js";import"./evo-icon-chevron-down-16-DlJj6fZt.js";import"./index-qYrWtsuo.js";const b="<ul></ul>",v=" b",k=d(3,t=>{const e={...t.c,open:Array.isArray(t._.m)?t._.m.includes(t.M):t._.m===t.M,openChange:ft(t)};tt(t.a,e.alignment),et(t.a,e.class),nt(t.a,e.content),it(t.a,e.contentAs),at(t.a,e.leading),ot(t.a,e.size),rt(t.a,e.summary),ut(t.a,(({alignment:o,class:r,content:p,contentAs:_,leading:f,size:u,summary:z,...O})=>O)(e))}),w=U(0,k),st=t=>{w._(t),Z(t.a)},lt=i(2,k),mt=(t,e)=>lt(t,e[0]),ct=(t,e)=>N(t.a,"aria-roledescription",e),h=(t,e)=>ct(t,e!==void 0?e:"accordion"),m=M(12,w),S=d(5,t=>m(t,t.d,t.e)),y=i(3,S),q=i(4,S),x=d(15,t=>J(t.a,["accordion",t.h==="large"&&"accordion--large",t.g,t.o&&"accordion--animated"]),2),R=W(14,x);function C(t){R(t,!1)}const D=i(6,x),E=i(7,x),dt=L("awmAXeH",t=>B(t,"a")),$=i(10,t=>{P(t,"a",t.k,{"aria-roledescription":1,class:1}),dt(t)}),pt=K(0,(t=>`<li>${t}</li>`)(X),(t=>`D/${t}&l`)(Y),st,mt),I=(t,e)=>pt(t,[e]),_t=(t,e)=>{(({a11yText:o,class:r,item:p,open:_,openChange:f,size:u,...z})=>$(t,z))(e),y(t,e.open),q(t,e.openChange),D(t,e.class),E(t,e.size),I(t,e.item),h(t,e.a11yText)},ft=t=>function(e){if(R(t._,!0),Array.isArray(t._.m)){const o=t._.m;e?o.includes(t.M)||m(t._,[...o,t.M]):m(t._,o.filter(r=>r!==t.M))}else m(t._,e?t.M:-1)},gt=g("h2nN9mM",b,v,C,_t),bt=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        evo-accordion
    </span>
