import{b as i}from"./utils-DyU2_5R1.js";import{_ as e,a as r,k as n,l as a}from"./dom-B_aQtK5Z.js";import{$ as s,a as l,b as m,c,C as h}from"./index-Ttymo4Mi.js";import{$,a as y,b as g,c as v}from"./evo-icon-settings-24-akrbXawJ.js";import{$ as k,a as w,b as T,c as _}from"./evo-icon-overflow-vertical-16-DgpgdpKG.js";import"./iframe-DMl2D3CN.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B70djrZG.js";import"./index-CbvBTQbH.js";import"./index-v-vPhLax.js";import"./evo-icon-spinner-24-CYQqzRmH.js";import"./index-fw6h05cN.js";import"./evo-icon-chevron-down-16-CNjCMSU5.js";import"./index-fCpBCq1T.js";import"./controllable.feat-CmDpOgp5.js";import"./controllable-input.feat-BWTl2t6G.js";import"./controllable-open.feat-Co2vF3JB.js";import"./controllable-select.feat-BWENUZLB.js";/* empty css                    */import"./index-Bt5fxXhg.js";import"./evo-icon-tick-16-gfhdusqr.js";/* empty css             */import"./index-DbU098SS.js";import"./evo-icon-chevron-down-12-MHI6FC5E.js";/* empty css                    */const x=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
...
`,S=s,C=(t=>`/${t}&`)(c),L=e("ItkS$Nk","item 3"),E=e("$Rg$sk5","item 2"),W=e("Actsz4K","item 1"),A=e("v5Gpcwl","eBay Menu");function B(t){m(t.a)}const D=(t,o)=>l(t.a,{...o,item:n(n(a({href:"#",content:W(t)}),{type:"button",content:E(t)}),{href:"#",content:L(t)}),content:A(t)}),M=r("iSSiHAa",S,C,B,D),R=`<evo-fake-menu-button ...input>
    <@item href="#">
        item 1
    </@item>
    <@item type="button">
...
`,z=s,O=(t=>`/${t}&`)(c),H=e("fdL54$n","item 3"),I=e("Uz_sSP4","item 2"),U=e("TVLl3S5","item 1"),V=t=>{g(t.a),v(t.a,{})},N=e("kBZuUQr",(t=>`Settings ${t}`)(y),(t=>`b/${t}&`)($),V);function q(t){m(t.a)}const P=(t,o)=>l(t.a,{...o,item:n(n(a({type:"button",content:U(t)}),{type:"button",content:I(t)}),{type:"button",content:H(t)}),content:N(t)}),Z=r("cQN$2DW",z,O,q,P),K=`<evo-fake-menu-button ...input>
    Settings <evo-icon-settings-24/>
    <@item type="button">item 1</@item>
    <@item type="button">item 2</@item>
    <@item type="button">item 3</@item>
</evo-fake-menu-button>
`,Q=s,j=(t=>`/${t}&`)(c),F=e("GvcQB9D","item 3"),G=e("BK$POqW","item 2"),J=e("PR6Awlf","item 1 that has very long text"),X=e("BpZa6rS","<span class=custom-label-flag></span>"),Y=e("CDjZzT4","This is the label you first see");function tt(t){m(t.a)}const et=(t,o)=>l(t.a,{...o,label:a({content:X(t)}),item:n(n(a({href:"#",content:J(t)}),{href:"#",content:G(t)}),{href:"#",content:F(t)}),content:Y(t)}),nt=r("E6nvalR",Q,j,tt,et),ot=`<style>
...
`,at=s,it=(t=>`/${t}&`)(c),rt=e("Sens0AS","item 4"),st=e("qazCWoD","item 3"),lt=e("N6id1$8","item 2"),mt=e("Vu1R_6$","item 1"),ct=e("RZsCEiL","eBay Menu separator");function pt(t){m(t.a)}const ut=(t,o)=>l(t.a,{...o,item:n(n(n(n(a({href:"#",content:mt(t)}),{href:"#",content:lt(t)}),{separator:!0}),{href:"#",content:st(t)}),{href:"#",content:rt(t)}),content:ct(t)}),bt=r("Vq698wL",at,it,pt,ut),dt=`<evo-fake-menu-button ...input>
