import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-CK-NQdWx.js";import{t as r}from"./classnames-D09xBJOL.js";import{r as i}from"./utils-i55QFFMK.js";import{n as a}from"./iframe-gJAJ_Vni.js";import{n as o,t as s}from"./ebay-details-DzKIWT0d.js";import{t as c}from"./utils-BI15M-bA.js";import{i as l,n as u,r as d,t as f}from"./ebay-icon-graph-16-CFTy1lES.js";import{n as p,t as m}from"./ebay-icon-lightbulb-16-BQR8ekmF.js";var h,g,_;function v(){return(v=t((()=>{h=e(r()),g=e(n()),s(),c(),_=({size:e,autoCollapse:t,a11yHeadingTag:n=`h4`,className:r,children:a,onToggle:s,"aria-roledescription":c=`accordion`,...l})=>{let u=(0,g.useRef)(null),[d,f]=(0,g.useState)(!1),p=i(a,o);if(!p.length)throw Error(`EbayAccordion: Please use a
        EbayDetails that defines the sections of the accordion`);let m=p.map((e,r)=>g.cloneElement(e,{a11yHeadingTag:n,onToggle:(n,{open:i})=>{f(!0),t&&i&&(u.current?.querySelectorAll(`details`))?.forEach((e,t)=>{t!==r&&(e.open=!1)}),e.props.onToggle?.(n,{open:i}),s?.(n,{open:i,index:r})}}));return g.createElement(`ul`,{...l,ref:u,className:(0,h.default)(`accordion`,r,{"accordion--large":e===`large`,"accordion--animated":d}),"aria-roledescription":c},m.map(e=>g.createElement(`li`,{key:e.key},e)))};try{_.displayName=`accordion`,_.__docgenInfo={description:``,displayName:`accordion`,filePath:`/home/runner/work/evo-web/evo-web/packages/ebayui-core-react/src/ebay-accordion/accordion.tsx`,methods:[],props:{size:{defaultValue:null,declarations:[{fileName:`ebayui-core-react/src/ebay-accordion/accordion.tsx`,name:`TypeLiteral`}],description:``,name:`size`,required:!1,tags:{},type:{name:`"large" | "regular" | undefined`}},autoCollapse:{defaultValue:null,declarations:[{fileName:`ebayui-core-react/src/ebay-accordion/accordion.tsx`,name:`TypeLiteral`}],description:``,name:`autoCollapse`,required:!1,tags:{},type:{name:`boolean | undefined`}},a11yHeadingTag:{defaultValue:{value:`h4`},declarations:[{fileName:`ebayui-core-react/src/ebay-accordion/accordion.tsx`,name:`TypeLiteral`}],description:``,name:`a11yHeadingTag`,required:!1,tags:{},type:{name:`keyof IntrinsicElements | undefined`}}},tags:{}}}catch{}})))()}function y(){return(y=t((()=>{v(),s()})))()}var b,x,S,C,w,T,E,D;function O(){return(O=t((()=>{n(),y(),s(),l(),u(),p(),b=a(),x={component:_,title:`navigation & disclosure/ebay-accordion`,argTypes:{size:{description:`Size of the accordion`,table:{defaultValue:{summary:`regular`}},options:[`regular`,`large`],control:{type:`select`}},autoCollapse:{type:`boolean`,description:`Whether to auto collapse`,table:{defaultValue:{summary:`false`}}},a11yHeadingTag:{description:"Heading tag for each accordion header (default: `h4`)",control:`text`,table:{defaultValue:{summary:`h4`}}},onToggle:{action:`onToggle`,description:`Triggered on toggle`,table:{category:`Events`,defaultValue:{summary:`event, { open, index }`}}}},tags:[`autodocs`],parameters:{docs:{description:{component:`## Usage
