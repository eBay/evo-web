import{j as e}from"./iframe-DjAcWYNC.js";import{u as f,E as r}from"./infotip-HnZMDA30.js";import{c as u}from"./index-C04a5A_d.js";import"./preload-helper-PPVm8Dsz.js";import"./close-16-CIbcQht1.js";import"./icon-OW-XSJJv.js";import"./icon-button-CXOadnWZ.js";/* empty css               */import"./use-controllable-id-DgzLbo8y.js";function n({as:t="span",id:i,className:s,children:p,...l}){const{headingId:d,setHeadingId:c}=f(),m=i??d;return i&&c(i),e.jsx(t,{...l,id:m,className:u("infotip__heading",s),children:p})}try{n.displayName="EvoInfotipHeading",n.__docgenInfo={description:"",displayName:"EvoInfotipHeading",filePath:"/home/runner/work/evo-web/evo-web/packages/evo-react/src/infotip/infotip-heading.tsx",methods:[],props:{as:{defaultValue:{value:"span"},declarations:[{fileName:"evo-react/src/infotip/types.ts",name:"TypeLiteral"}],description:"Element used for the heading. Defaults to `span`.",name:"as",required:!1,tags:{},type:{name:"ElementType"}}},tags:{}}}catch{}const H={title:"notices & tips/evo-infotip",component:r,subcomponents:{EvoInfotipHeading:n},tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...o.parameters?.docs?.source}}};export{a as Default,o as WrappedParagraph,_ as __namedExportsOrder,H as default};
