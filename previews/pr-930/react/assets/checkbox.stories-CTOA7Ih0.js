import{j as e}from"./iframe-DjAcWYNC.js";/* empty css              */import{c as m}from"./index-C04a5A_d.js";import{E as h,a as p}from"./checkbox-unchecked-18-DSVhiKT8.js";import{E as b,a as x}from"./checkbox-unchecked-24-BMjo3Uye.js";import"./preload-helper-PPVm8Dsz.js";import"./icon-OW-XSJJv.js";function s({className:o,ref:a,size:c,style:i,...d}){const t=c==="large";return e.jsxs("span",{className:m("checkbox",t&&"checkbox--large",o),style:i,children:[e.jsx("input",{...d,ref:a,className:"checkbox__control",type:"checkbox"}),e.jsx("span",{className:"checkbox__icon",hidden:!0,children:t?e.jsxs(e.Fragment,{children:[e.jsx(b,{className:"checkbox__unchecked"}),e.jsx(x,{className:"checkbox__checked"})]}):e.jsxs(e.Fragment,{children:[e.jsx(h,{className:"checkbox__unchecked"}),e.jsx(p,{className:"checkbox__checked"})]})})]})}try{s.displayName="EvoCheckbox",s.__docgenInfo={description:"",displayName:"EvoCheckbox",filePath:"/home/runner/work/evo-web/evo-web/packages/evo-react/src/checkbox/checkbox.tsx",methods:[],props:{size:{defaultValue:null,declarations:[{fileName:"evo-react/src/checkbox/types.ts",name:"TypeLiteral"}],description:"Uses the large checkbox icon. Omit for the default size.",name:"size",required:!1,tags:{},type:{name:'"large"'}}},tags:{}}}catch{}const j={title:"form input/evo-checkbox",component:s,tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...l.parameters?.docs?.source}}};export{n as Default,l as Group,r as Isolated,y as __namedExportsOrder,j as default};
