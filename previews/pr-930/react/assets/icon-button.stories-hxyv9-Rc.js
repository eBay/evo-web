...
\`\`\`
`}}}},p={render:o=>e.jsxs(t,{...o,href:"https://ebay.com",a11yText:"Chat",onClick:n=>n.preventDefault(),children:[e.jsx(E,{}),e.jsx(r,{number:99})]})},j=["Default","WithBadge","AsLink","WithCustomLinkComponent","WithChat"];s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
...
}`,...p.parameters?.docs?.source}}};export{i as AsLink,s as Default,c as WithBadge,p as WithChat,u as WithCustomLinkComponent,j as __namedExportsOrder,S as default};
