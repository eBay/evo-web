import{_ as e,i as t}from"./_Cof3au2K.js";import"./_BA2w06lR.js";e("DZqDKPd",i=>window.addEventListener("load",()=>{document.querySelector("button").addEventListener("click",function(s){document.querySelector("main").innerHTML+=`
    ...
    `,setTimeout(()=>{document.querySelectorAll(".skeleton:not([hidden])")[0].hidden=!0,document.querySelector("main").innerHTML+=`
      <div class="items">
        <div>
      ...
      `},3e3)})}));t();
//# sourceMappingURL=guide-examples.skeleton-examples.csr.example-1-Duf3x9MH.js.map
