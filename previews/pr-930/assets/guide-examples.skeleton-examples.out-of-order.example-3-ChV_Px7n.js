import{_ as e,i as t}from"./_Cof3au2K.js";import"./_BA2w06lR.js";e("A$DEU6a",a=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
    ...
    `},250),setTimeout(()=>{document.querySelector("nav").innerHTML=`
      <ul>
        <li><a href="#">World</a>
        <li><a href="#">U.S.</a>
    ...
    `},500),setTimeout(()=>{document.querySelector("#hero").innerHTML=`
    ...
    `},500),setTimeout(()=>{document.querySelector("#featured-1").innerHTML=`
      <div class="page-grid">
    ...
    `},600),setTimeout(()=>{document.querySelector("#featured-2").innerHTML=`
      <div class="page-grid">
        <div class="featured__article">
    ...
    `},700),setTimeout(()=>{document.querySelector("main").innerHTML=`
      <article>
      ...
      `},3e3),setTimeout(()=>{document.querySelector("#section-1").innerHTML=`
      <h2>About</h2>
    ...
    `},750),setTimeout(()=>{document.querySelector("#section-2").innerHTML=`
      <h2>Archives</h2>
      <p>Etiam porta sem malesuada magna mollis euismod. Cras mattis consectetur purus sit amet fermentum. Aenean lacinia bibendum nulla sed consectetur.</p>
    `},500),setTimeout(()=>{document.body.innerHTML+=`
    ...
    `},500)}));t();
//# sourceMappingURL=guide-examples.skeleton-examples.out-of-order.example-3-ChV_Px7n.js.map
