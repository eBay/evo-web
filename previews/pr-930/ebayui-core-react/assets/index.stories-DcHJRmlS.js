...
\`\`\``}}}},e=o(t=>r.createElement(a,{...t},"Chip Content"),"Default"),y=["Default"];e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"args => <EbayChip {...args}>Chip Content</EbayChip>",...e.parameters?.docs?.source}}};export{e as Default,y as __namedExportsOrder,h as default};
