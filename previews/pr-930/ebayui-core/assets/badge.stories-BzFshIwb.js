...
`,o=a=>({input:a}),c={title:"graphics & icons/ebay-badge",component:n,parameters:{docs:{description:{component:s}}},argTypes:{number:{type:"number",description:"Used as the number to be placed in the badge"},"aria-label":{description:'A descriptive label of what the badge represents (e.g. "5 unread items")'}}},e=o.bind({});e.args={number:5,"aria-label":"5 unread items"};e.parameters={docs:{source:{code:t("ebay-badge",e.args)}}};const m=["Standard"];e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`(args: Input) => ({
  input: args
})`,...e.parameters?.docs?.source}}};export{e as Standard,m as __namedExportsOrder,c as default};
