...
`,fe={title:"layout/ebay-card",component:n,parameters:{docs:{description:{component:F}}},argTypes:{renderBody:{control:{type:"text"}},layout:{control:{type:"select"},options:["horizontal","vertical"],description:"The layout of the card. The default is vertical. The horizontal option takes up more horizontal space and is better for displaying more information."},href:{control:{type:"text"},description:"The URL to navigate to when the card is clicked. This can only be used in conjunction without a action element"},aspectRatio:{control:{type:"select"},options:["16:9","5:4","default"],description:"The aspect ratio applied to the image."},disabled:{control:{type:"boolean"},description:"True if the card is not clickable"},image:{name:"@image",table:{category:"@attribute tags"},description:"The top image tag. Will be passed as attributes to the <img> tag."},title:{name:"@title",description:"The title element of the card",table:{category:"@attribute tags"}},action:{name:"@action",description:"The action element of the card",table:{category:"@attribute tags"}},overline:{name:"@overline",description:"The overline element of the card. This is generally used for signals rendered above the title.",table:{category:"@attribute tags"}},description:{name:"@description",description:'The description element of the card. This is to render a description below the title in tertiary element. Defaults to <p> tag (use "as" attribute to change).',table:{category:"@attribute tags"}},onClick:{action:"on-click",description:"Triggered when card is clicked",table:{category:"Events",defaultValue:{summary:""}}}}},$=E(d,Z),B=E(p,ee),x=E(m,te),A=E(u,ae),_e=["Default","Anchor","Button","Minimum"];$.parameters={...$.parameters,docs:{...$.parameters?.docs,source:{originalSource:"buildExtensionTemplate(DefaultTemplate, DefaultTemplateCode)",...$.parameters?.docs?.source}}};B.parameters={...B.parameters,docs:{...B.parameters?.docs,source:{originalSource:"buildExtensionTemplate(AnchorTemplate, AnchorTemplateCode)",...B.parameters?.docs?.source}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:"buildExtensionTemplate(ButtonTemplate, ButtonTemplateCode)",...x.parameters?.docs?.source}}};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:"buildExtensionTemplate(MinimumTemplate, MinimumTemplateCode)",...A.parameters?.docs?.source}}};export{B as Anchor,x as Button,$ as Default,A as Minimum,_e as __namedExportsOrder,fe as default};
