import{b as T}from"./utils-DyU2_5R1.js";import{_ as i,f as a,h as s,I as L,v as r,q as k,w as D,N as E,i as c,k as A,l as I}from"./dom-DzaaZrG-.js";import{_ as C}from"./preload-helper-PPVm8Dsz.js";import"./controllable.feat-D0_o5xgz.js";import{$ as S,a as P,b as V,c as j}from"./evo-icon-attention-24-pKE6AQRH.js";import{$ as z,a as q,b as O,c as B,d as R,e as Z}from"./index-Cqmv-JVY.js";import"./iframe-W1YmnRsb.js";import"./controllable-input.feat-D1awevao.js";import"./controllable-open.feat-DMAF1Hoc.js";import"./controllable-select.feat-CEdaIxhF.js";import"./index-CSnbFevZ.js";const G=`<h1 style='display: flex; justify-content: space-between; align-items: center;'>
    <span>
        evo-3d-viewer
    </span>
...
/>
`,xe={title:"media/evo-3d-viewer",component:Y,parameters:{docs:{description:{component:G}}},argTypes:{src:{control:"text",description:"The asset to load"},a11yLoadingText:{type:{name:"string",required:!0},control:{type:"text"},table:{category:"Accessibility",defaultValue:{summary:"Loading"}},description:"Localized text for loading icon loading viewer"},errorText:{type:{name:"string",required:!0},control:"text",description:"Localized text to show error message"},onLoadError:{description:"Triggered when there is an error during loading",table:{category:"Events"}}}},o=T(oe,re),we=["Default"];o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"buildExtensionTemplate(DefaultTemplate, DefaultTemplateCode)",...o.parameters?.docs?.source}}};export{o as Default,we as __namedExportsOrder,xe as default};
