import{b as z}from"./utils-DyU2_5R1.js";import{_ as g,f as i,g as P,I as N,i as A,l as W,m as d,h as J,u as K,w as j,o as M,L as U,b as n,Z as c,S as a,T as B,N as F,a4 as Z,E as G}from"./dom-DzaaZrG-.js";import{$ as Q,j as X,g as Y,a as tt,b as et,i as nt,c as it,d as at,e as ot,h as rt,f as ut}from"./index-D7eCJID5.js";import"./iframe-W1YmnRsb.js";import"./preload-helper-PPVm8Dsz.js";import"./controllable-open.feat-DMAF1Hoc.js";import"./evo-icon-chevron-down-16-CYThcKDz.js";import"./index-CSnbFevZ.js";const b="<ul></ul>",h=" b",k=d(3,t=>{const e={...t.c,open:Array.isArray(t._.m)?t._.m.includes(t.M):t._.m===t.M,openChange:ft(t)};tt(t.a,e.alignment),et(t.a,e.class),nt(t.a,e.content),it(t.a,e.contentAs),at(t.a,e.leading),ot(t.a,e.size),rt(t.a,e.summary),ut(t.a,(({alignment:o,class:r,content:p,contentAs:_,leading:f,size:u,summary:L,...O})=>O)(e))}),w=U(0,k),st=t=>{w._(t),Y(t.a)},lt=i(2,k),mt=(t,e)=>lt(t,e[0]),ct=(t,e)=>j(t.a,"aria-roledescription",e),v=(t,e)=>ct(t,e!==void 0?e:"accordion"),m=M(12,w),S=d(5,t=>m(t,t.d,t.e)),y=i(3,S),q=i(4,S),x=d(15,t=>J(t.a,["accordion",t.h==="large"&&"accordion--large",t.g,t.o&&"accordion--animated"]),2),R=N(14,x);function C(t){R(t,!1)}const D=i(6,x),E=i(7,x),dt=A("awmAXeH",t=>W(t,"a")),$=i(10,t=>{P(t,"a",t.k,{"aria-roledescription":1,class:1}),dt(t)}),pt=K(0,(t=>`<li>${t}</li>`)(Q),(t=>`D/${t}&l`)(X),st,mt),I=(t,e)=>pt(t,[e]),_t=(t,e)=>{(({a11yText:o,class:r,item:p,open:_,openChange:f,size:u,...L})=>$(t,L))(e),y(t,e.open),q(t,e.openChange),D(t,e.class),E(t,e.size),I(t,e.item),v(t,e.a11yText)},ft=t=>function(e){if(R(t._,!0),Array.isArray(t._.m)){const o=t._.m;e?o.includes(t.M)||m(t._,[...o,t.M]):m(t._,o.filter(r=>r!==t.M))}else m(t._,e?t.M:-1)},gt=g("h2nN9mM",b,h,C,_t),bt=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        evo-accordion
    </span>
