import{b as d}from"./utils-DyU2_5R1.js";import{b as n,_ as y,f as a,S as i,m as A}from"./dom-DzaaZrG-.js";import{$ as h,a as f,b as T,c as _,d as v,e as S,f as C,g as k,h as w,i as $,j as x,k as I,l as W,m as P,T as H}from"./index-CBWiCAVq.js";import{$ as O,a as j,b as B,c as U}from"./evo-icon-archive-24-CuWOMJ1-.js";import"./iframe-W1YmnRsb.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CSnbFevZ.js";const N=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        evo-toggle-button
    </span>
...
`,q=h,J=(t=>`/${t}&`)(P),V=n("WIB4gO9","Title");function G(t){I(t.a),W(t.a,V(t))}const X=a(2,t=>{f(t.a,t.c.class),T(t.a,t.c.icon),_(t.a,t.c.image),v(t.a,t.c.layoutType),S(t.a,t.c.onClick),C(t.a,t.c.pressed),k(t.a,t.c.pressedChange),w(t.a,t.c.subtitle),$(t.a,t.c.title),x(t.a,(({class:e,content:s,icon:r,image:u,layoutType:o,onClick:M,pressed:E,pressedChange:L,subtitle:D,title:R,...c})=>c)(t.c))}),Y=y("O7Ncomx",q,J,G,X),F=`<evo-toggle-button ...input>Title</evo-toggle-button>
