import{b as w}from"./utils-DyU2_5R1.js";import{_ as y,f as n,q as g,h as k,i as _,l as c,w as I,m as b,a3 as $,b as r,e as x,n as f}from"./dom-DzaaZrG-.js";import"./iframe-W1YmnRsb.js";import"./preload-helper-PPVm8Dsz.js";const o="<div role=img></div>",s=" b",O=()=>{},S=(t,e)=>I(t.a,"aria-label",e),l=(t,e)=>S(t,e!==void 0?e:"Loading..."),a=(t,e)=>k(t.a,["skeleton",e]),E=_("GPH9OIk",t=>c(t,"a")),i=n(5,t=>{g(t,"a",t.f,{role:1,"aria-label":1,class:1}),E(t)}),A=(t,e)=>{(({a11yText:u,class:v,...d})=>i(t,d))(e),a(t,e.class),l(t,e.a11yText)},D=y("Fyt6AHW",o,s,O,A),C=`<h1 style="display: flex; justify-content: space-between; align-items: center;">
    <span>
        evo-skeleton
    </span>
...
`,q="<div></div>",H=" b",j=_("XC4nU0l",t=>c(t,"a")),z=b(5,t=>{$(t,"a",{class:["skeleton__avatar",t.d],...t.e}),j(t)}),B=n(3,z),J=n(4,z),G="<div></div>",M=" b",P=()=>{},V=_("RJpITzm",t=>c(t,"a")),h=b(6,t=>{$(t,"a",{class:["skeleton__button",t.e&&`skeleton__button--${t.e}`,t.d],...t.f}),V(t)},2),F=n(3,h),U=n(4,h),W=n(5,h),X="<div></div>",Q=" b",Z=(t,e)=>k(t.a,["skeleton__image",e]),K=_("Vtlz6Qb",t=>c(t,"a")),N=n(2,t=>{g(t,"a",t.c,{class:1}),Z(t,t.c.class),K(t)}),Y="<div></div>",tt=" b",et=()=>{},nt=_("qEHqTJo",t=>c(t,"a")),p=b(7,t=>{$(t,"a",{class:["skeleton__text",t.e&&"skeleton__text--multiline",t.d==="large"&&"skeleton__text--large",t.f],...t.g}),nt(t)},3),ot=n(3,p),st=n(4,p),lt=n(5,p),at=n(6,p),it="<div></div>",_t=" b",ct=(t,e)=>k(t.a,["skeleton__textbox",e]),dt=_("yrL0pFE",t=>c(t,"a")),rt=n(2,t=>{g(t,"a",t.c,{class:1}),ct(t,t.c.class),dt(t)}),ut="_grid_19xiq_2";const vt=((t,e,u,v,d)=>`<div><div>${t}<code>&lt;evo-skeleton-avatar&gt;</code></div><div>${e}<code>&lt;evo-skeleton-button&gt;</code></div><div>${u}<code>&lt;evo-skeleton-image&gt;</code></div><div>${v}<code>&lt;evo-skeleton-text&gt;</code></div><div>${d}<code>&lt;evo-skeleton-textbox&gt;</code></div></div>`)(o,o,o,o,o),mt=((t,e,u,v,d)=>` E/${t}&lD/${e}&lD/${u}&lD/${v}&lD/${d}&m`)(s,s,s,s,s),kt=t=>rt(t.a,{}),pt=r("bSraL2J",it,(t=>`/${t}&`)(_t),kt),gt=t=>N(t.a,{}),bt=r("$PXSS57",X,(t=>`/${t}&`)(Q),gt),$t=t=>{B(t.a),J(t.a,{})},xt=r("j5gPgha",q,(t=>`/${t}&`)(H),$t),T=x(10,t=>ot(t.a,t._.i)),ht=t=>{T(t),L(t),et(t.a),lt(t.a),at(t.a,{})},L=x(11,t=>st(t.a,t._.j)),yt=r("AfG5BkG",Y,(t=>`/${t}&`)(tt),ht),R=x(10,t=>U(t.a,t._.i)),ft=t=>{R(t),P(t.a),F(t.a),W(t.a,{})},zt=r("DSipC6J",G,(t=>`/${t}&`)(M),ft);function Tt(t){k(t.a,ut),l(t.b,"Loading..."),a(t.b),i(t.b,{content:xt(t)}),l(t.c,"Loading..."),a(t.c),i(t.c,{content:zt(t)}),l(t.d,"Loading..."),a(t.d),i(t.d,{content:bt(t)}),l(t.e,"Loading..."),a(t.e),i(t.e,{content:yt(t)}),l(t.f,"Loading..."),a(t.f),i(t.f,{content:pt(t)})}const Lt=(t,e)=>{wt(t,e.size),Ot(t,e.multiline)},Rt=f(R,T),wt=n(8,Rt),It=f(L),Ot=n(9,It),St=y("TZmAR$8",vt,mt,Tt,Lt),Et=`export interface Input {
  a11yText: string;
  size?: "small" | "large";
  multiline: boolean;
}
