import{C as e,v as t}from"./_XkvwCyHu.js";import"./_C5Dh7mzz.js";t(`hm2iUpw`,e=>window.addEventListener(`load`,()=>{document.querySelector(`button`).addEventListener(`click`,function(e){document.querySelector(`main`).innerHTML+=`
    ...
    `,setTimeout(()=>{document.querySelectorAll(`.skeleton:not([hidden])`)[0].hidden=!0,document.querySelector(`main`).innerHTML+=`
      ...
      `},3e3)})})),e();
//# sourceMappingURL=guide-examples.skeleton-examples.csr-Db2B-qjh.js.map