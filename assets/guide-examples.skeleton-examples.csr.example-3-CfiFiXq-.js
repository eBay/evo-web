import{_ as e,i as t}from"./_DNKpHrMs.js";import"./_w3CD5vCv.js";e("Erz$CMU",i=>window.addEventListener("load",()=>{document.querySelector("button").addEventListener("click",function(s){document.querySelector("main").innerHTML=`
    ...
    `,setTimeout(()=>{document.querySelector(".skeleton").hidden=!0,document.querySelector("button").disabled=!0,document.querySelector("main").innerHTML=`
      ...
      `},3e3)})}));t();
//# sourceMappingURL=guide-examples.skeleton-examples.csr.example-3-CfiFiXq-.js.map
