import{_ as e,i as a}from"./_DNKpHrMs.js";import"./_w3CD5vCv.js";e("Lq18id5",t=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},3750)}));a();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order.example-2b-BsmzVrRw.js.map
