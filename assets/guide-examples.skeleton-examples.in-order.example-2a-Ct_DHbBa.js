import{_ as e,i as a}from"./_DNKpHrMs.js";import"./_w3CD5vCv.js";e("tWSMR4o",t=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},4e3)}));a();
//# sourceMappingURL=guide-examples.skeleton-examples.in-order.example-2a-Ct_DHbBa.js.map
