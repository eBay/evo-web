import{_ as e,i as t}from"./_DNKpHrMs.js";import"./_w3CD5vCv.js";e("DZqDKPd",i=>window.addEventListener("load",()=>{document.querySelector("button").addEventListener("click",function(s){document.querySelector("main").innerHTML+=`
    ...
    `,setTimeout(()=>{document.querySelectorAll(".skeleton:not([hidden])")[0].hidden=!0,document.querySelector("main").innerHTML+=`
      ...
      `},3e3)})}));t();
//# sourceMappingURL=guide-examples.skeleton-examples.csr.example-1-BEKeyBQv.js.map
