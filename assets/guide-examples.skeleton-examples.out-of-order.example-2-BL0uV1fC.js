import{_ as e,i as a}from"./_DNKpHrMs.js";import"./_w3CD5vCv.js";e("kh_wIfq",t=>window.addEventListener("load",()=>{setTimeout(()=>{document.querySelector(".page-grid").innerHTML+=`
      <nav>
        <ul>
          <li><a href="#">World</a>
          <li><a href="#">U.S.</a>
    ...
    `},750)}));a();
//# sourceMappingURL=guide-examples.skeleton-examples.out-of-order.example-2-BL0uV1fC.js.map
